...
- 用户确认先完成核心板基础、通信/存储、ADC/PWM安全配置，再进行外部通信和0x0400～0x040A；软件通过即继续，实板状态单独记录。当前已建立 LOW_VOLTAGE_V04_REVIEW.md 覆盖表，核心基础修正完成，EMIF/W5300总线隔离已完成并通过主机测试/CCS构建；下一项为CAN/SCI/SPI通信与存储复核。
