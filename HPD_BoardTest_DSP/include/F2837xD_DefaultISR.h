...
interrupt void IPC0_ISR(void);                        // 1.13 - IPC Interrupt 1
interrupt void IPC1_ISR(void);                        // 1.14 - IPC Interrupt 2
interrupt void IPC2_ISR(void);                        // 1.15 - IPC Interrupt 3
interrupt void IPC3_ISR(void);                        // 1.16 - IPC Interrupt 4
