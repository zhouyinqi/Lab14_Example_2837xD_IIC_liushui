...
struct CHIDESC2_BITS {                                // bit descriptions
    Uint16  LOFFSET:16;                              // 15:0 Offset from the current line starting address to the next line starting address for DMA Channel I tranfers. 
    Uint16  rsvd1:16;                                 // 31:16 Reserved 
};
...
struct CHQDESC2_BITS {                                // bit descriptions
    Uint16  LOFFSET:16;                               // 15:0 Offset from the current line starting address to the next line starting address for DMA Channel Q tranfers. 
    Uint16  rsvd1:16;                                 // 31:16 Reserved 
};
