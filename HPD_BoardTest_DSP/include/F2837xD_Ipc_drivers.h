...
#ifndef F2837x_IPC_DRIVERS_H
#define F2837x_IPC_DRIVERS_H
...
// global circular buffer variables g_asIPCCPU1toCPU2Buffers and g_asIPCCPU2toCPU1Buffers.
...
extern void IPCInitialize (volatile tIpcController *psController, uint16_t usCPU2IpcInterrupt,
                            uint16_t usCPU1IpcInterrupt);
extern uint16_t IpcPut (volatile tIpcController *psController, tIpcMessage *psMessage,
                        uint16_t bBlock);
extern uint16_t IpcGet (volatile tIpcController *psController, tIpcMessage *psMessage,
                        uint16_t bBlock);
extern uint16_t IPCLtoRDataRead (volatile tIpcController *psController, uint32_t ulAddress,
...
extern uint16_t IPCLtoRDataRead_Protected (volatile tIpcController *psController,
                                       ...
                                       uint16_t bBlock, uint32_t ulResponseFlag);
extern uint16_t IPCLtoRSetBits(volatile tIpcController *psController, uint32_t ulAddress,
...
extern uint16_t IPCLtoRSetBits_Protected(volatile tIpcController *psController,
                                         ...
                                         uint16_t bBlock);
extern uint16_t IPCLtoRClearBits(volatile tIpcController *psController, uint32_t ulAddress,
                             uint32_t ulMask, uint16_t usLength,uint16_t bBlock);
extern uint16_t IPCLtoRClearBits_Protected(volatile tIpcController *psController,
                                       uint32_t ulAddress, uint32_t ulMask, uint16_t usLength,
                                       uint16_t bBlock);
extern uint16_t IPCLtoRDataWrite(volatile tIpcController *psController, uint32_t ulAddress,
...
extern uint16_t IPCLtoRDataWrite_Protected(volatile tIpcController *psController,
                                        uint32_t ulAddress, uint32_t ulData, uint16_t usLength,
                                        uint16_t bBlock,uint32_t ulResponseFlag);    
extern uint16_t IPCLtoRBlockRead(volatile tIpcController *psController, uint32_t ulAddress,
                             uint32_t ulShareAddress, uint16_t usLength, uint16_t bBlock,
                             uint32_t ulResponseFlag);
extern uint16_t IPCLtoRBlockWrite(volatile tIpcController *psController, uint32_t ulAddress,
                              uint32_t ulShareAddress, uint16_t usLength, uint16_t usWordLength,
                              uint16_t bBlock);
extern uint16_t IPCLtoRBlockWrite_Protected(volatile tIpcController *psController,
                                        ...
                                        uint16_t bBlock);
extern uint16_t IPCLtoRFunctionCall(volatile tIpcController *psController, uint32_t ulAddress,
                                uint32_t ulParam, uint16_t bBlock);
extern uint16_t IPCLtoRSendMessage(volatile tIpcController *psController, uint32_t ulCommand,
...
extern void IPCRtoLDataRead(volatile tIpcController *psController, tIpcMessage *psMessage,
                            uint16_t bBlock);
...
extern uint16_t IPCLiteLtoRGetResult (void *pvData, uint16_t usLength, uint32_t ulStatusFlag);
extern uint16_t IPCLiteLtoRDataRead(uint32_t ulFlag, uint32_t ulAddress, uint16_t usLength,
                                    uint32_t ulStatusFlag);
extern uint16_t IPCLiteLtoRSetBits(uint32_t ulFlag, uint32_t ulAddress, uint32_t ulMask,
                                   uint16_t usLength,uint32_t ulStatusFlag);
extern uint16_t IPCLiteLtoRSetBits_Protected (uint32_t ulFlag, uint32_t ulAddress, uint32_t ulMask,
                                              uint16_t usLength,uint32_t ulStatusFlag);
extern uint16_t IPCLiteLtoRClearBits(uint32_t ulFlag, uint32_t ulAddress, uint32_t ulMask,
                                     uint16_t usLength,uint32_t ulStatusFlag);
extern uint16_t IPCLiteLtoRClearBits_Protected (uint32_t ulFlag, uint32_t ulAddress, uint32_t ulMask,
                                                uint16_t usLength,uint32_t ulStatusFlag);
extern uint16_t IPCLiteLtoRDataWrite(uint32_t ulFlag, uint32_t ulAddress, uint32_t ulData,
                                     uint16_t usLength,uint32_t ulStatusFlag);
extern uint16_t IPCLiteLtoRDataWrite_Protected(uint32_t ulFlag, uint32_t ulAddress, uint32_t ulData,
                                               uint16_t usLength,uint32_t ulStatusFlag);
extern uint16_t IPCLiteLtoRFunctionCall(uint32_t ulFlag, uint32_t ulAddress, uint32_t ulParam,
                                        uint32_t ulStatusFlag);
extern uint16_t IPCLiteReqMemAccess (uint32_t ulFlag, uint32_t ulMask, uint16_t ulMaster,
                                     uint32_t ulStatusFlag);
...
extern void IPCLiteRtoLClearBits_Protected (uint32_t ulFlag, uint32_t ulStatusFlag);
extern void IPCLiteRtoLDataWrite(uint32_t ulFlag, uint32_t ulStatusFlag);
extern void IPCLiteRtoLDataWrite_Protected(uint32_t ulFlag, uint32_t ulStatusFlag);
