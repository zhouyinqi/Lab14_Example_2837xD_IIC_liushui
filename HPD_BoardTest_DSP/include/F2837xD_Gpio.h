...
// FILE:   F2837x_Gpio.h
//
// TITLE:  F2837x Device Gpio Register Definitions.
//
...
#ifndef F2837x_Gpio_H
#define F2837x_Gpio_H
#ifdef __cplusplus
extern "C" {
#endif
...
struct GPACTRL_BITS {                                 // bit descriptions
    Uint16  QUALPRD0:8;                               // 7:0 Specifies the qualification sampling period for GPIO0 to GPIO7 
    Uint16  QUALPRD1:8;                               // 15:8 Specifies the qualification sampling period for GPIO8 to GPIO15 
    Uint16  QUALPRD2:8;                               // 23:16 Specifies the qualification sampling period for GPIO16 to GPIO23 
    Uint16  QUALPRD3:8;                               // 31:24 Specifies the qualification sampling period for GPIO24 to GPIO31 
};
...
struct GPBCTRL_BITS {                                 // bit descriptions
    Uint16  QUALPRD0:8;                               // 7:0 Specifies the qualification sampling period for GPIO32 to GPIO39 
    Uint16  QUALPRD1:8;                               // 15:8 Specifies the qualification sampling period for GPIO40 to GPIO47 
    Uint16  QUALPRD2:8;                               // 23:16 Specifies the qualification sampling period for GPIO48 to GPIO55 
    Uint16  QUALPRD3:8;                               // 31:24 Specifies the qualification sampling period for GPIO56 to GPIO63 
};
...
struct GPCCTRL_BITS {                                 // bit descriptions
    Uint16  QUALPRD0:8;                               // 7:0 Specifies the qualification sampling period for GPIO64 to GPIO71 
    Uint16  QUALPRD1:8;                               // 15:8 Specifies the qualification sampling period for GPIO72 to GPIO79 
    Uint16  QUALPRD2:8;                               // 23:16 Specifies the qualification sampling period for GPIO80 to GPIO87 
    Uint16  QUALPRD3:8;                               // 31:24 Specifies the qualification sampling period for GPIO88 to GPIO95 
};
...
struct GPDCTRL_BITS {                                 // bit descriptions
    Uint16  QUALPRD0:8;                               // 7:0 Specifies the qualification sampling period for GPIO96 to GPIO103 
    Uint16  QUALPRD1:8;                               // 15:8 Specifies the qualification sampling period for GPIO104 to GPIO111 
    Uint16  QUALPRD2:8;                               // 23:16 Specifies the qualification sampling period for GPIO112 to GPIO119 
    Uint16  QUALPRD3:8;                               // 31:24 Specifies the qualification sampling period for GPIO120 to GPIO127 
};
...
struct GPECTRL_BITS {                                 // bit descriptions
    Uint16  QUALPRD0:8;                               // 7:0 Specifies the qualification sampling period for GPIO128 to GPIO135 
    Uint16  QUALPRD1:8;                               // 15:8 Specifies the qualification sampling period for GPIO136 to GPIO143 
    Uint16  QUALPRD2:8;                               // 23:16 Specifies the qualification sampling period for GPIO144 to GPIO151 
    Uint16  QUALPRD3:8;                               // 31:24 Specifies the qualification sampling period for GPIO152 to GPIO159 
};
...
struct GPFCTRL_BITS {                                 // bit descriptions
    Uint16  QUALPRD0:8;                               // 7:0 Specifies the qualification sampling period for GPIO160 to GPIO167 
    Uint16  QUALPRD1:8;                               // 15:8 Specifies the qualification sampling period for GPIO168 to GPIO175 
    Uint16  QUALPRD2:8;                               // 23:16 Specifies the qualification sampling period for GPIO176 to GPIO183 
    Uint16  QUALPRD3:8;                               // 31:24 Specifies the qualification sampling period for GPIO184 to GPIO191 
};
...
struct GPAQSEL1_BITS {                                // bit descriptions
...
struct GPBQSEL1_BITS {                                // bit descriptions
...
struct GPCQSEL1_BITS {                                // bit descriptions
...
struct GPDQSEL1_BITS {                                // bit descriptions
...
struct GPEQSEL1_BITS {                                // bit descriptions
...
struct GPFQSEL1_BITS {                                // bit descriptions
    ...
    Uint16  GPIO169:2;                                // 19:18 Select input qualification type for GPIO169 
    Uint16  GPIO170:2;                                // 21:20 Select input qualification type for GPIO170 
    Uint16  GPIO171:2;                                // 23:22 Select input qualification type for GPIO171 
    Uint16  GPIO172:2;                                // 25:24 Select input qualification type for GPIO172 
    Uint16  GPIO173:2;                                // 27:26 Select input qualification type for GPIO173 
    Uint16  GPIO174:2;                                // 29:28 Select input qualification type for GPIO174 
    Uint16  GPIO175:2;                                // 31:30 Select input qualification type for GPIO175 
};
...
struct GPAQSEL2_BITS {                                // bit descriptions
...
struct GPBQSEL2_BITS {                                // bit descriptions
...
struct GPCQSEL2_BITS {                                // bit descriptions
...
struct GPDQSEL2_BITS {                                // bit descriptions
...
struct GPEQSEL2_BITS {                                // bit descriptions
...
struct GPFQSEL2_BITS {                                // bit descriptions
    Uint16  GPIO176:2;                                // 1:0 Select input qualification type for GPIO176 
    Uint16  GPIO177:2;                                // 3:2 Select input qualification type for GPIO177 
    Uint16  GPIO178:2;                                // 5:4 Select input qualification type for GPIO178 
    Uint16  GPIO179:2;                                // 7:6 Select input qualification type for GPIO179 
    Uint16  GPIO180:2;                                // 9:8 Select input qualification type for GPIO180 
    Uint16  GPIO181:2;                                // 11:10 Select input qualification type for GPIO181 
    Uint16  GPIO182:2;                                // 13:12 Select input qualification type for GPIO182 
    Uint16  GPIO183:2;                                // 15:14 Select input qualification type for GPIO183 
    Uint16  GPIO184:2;                                // 17:16 Select input qualification type for GPIO184 
    Uint16  GPIO185:2;                                // 19:18 Select input qualification type for GPIO185 
    Uint16  GPIO186:2;                                // 21:20 Select input qualification type for GPIO186 
    Uint16  GPIO187:2;                                // 23:22 Select input qualification type for GPIO187 
    Uint16  GPIO188:2;                                // 25:24 Select input qualification type for GPIO188 
    Uint16  GPIO189:2;                                // 27:26 Select input qualification type for GPIO189 
    Uint16  GPIO190:2;                                // 29:28 Select input qualification type for GPIO190 
    Uint16  GPIO191:2;                                // 31:30 Select input qualification type for GPIO191 
};
...
struct GPAMUX1_BITS {                                 // bit descriptions
...
struct GPBMUX1_BITS {                                 // bit descriptions
...
struct GPCMUX1_BITS {                                 // bit descriptions
...
struct GPDMUX1_BITS {                                 // bit descriptions
...
struct GPEMUX1_BITS {                                 // bit descriptions
...
struct GPFMUX1_BITS {                                 // bit descriptions
    ...
    Uint16  GPIO169:2;                                // 19:18 Defines pin-muxing selection for GPIO169 
    Uint16  GPIO170:2;                                // 21:20 Defines pin-muxing selection for GPIO170 
    Uint16  GPIO171:2;                                // 23:22 Defines pin-muxing selection for GPIO171 
    Uint16  GPIO172:2;                                // 25:24 Defines pin-muxing selection for GPIO172 
    Uint16  GPIO173:2;                                // 27:26 Defines pin-muxing selection for GPIO173 
    Uint16  GPIO174:2;                                // 29:28 Defines pin-muxing selection for GPIO174 
    Uint16  GPIO175:2;                                // 31:30 Defines pin-muxing selection for GPIO175 
};
...
struct GPAMUX2_BITS {                                 // bit descriptions
...
struct GPBMUX2_BITS {                                 // bit descriptions
...
struct GPCMUX2_BITS {                                 // bit descriptions
...
struct GPDMUX2_BITS {                                 // bit descriptions
...
struct GPEMUX2_BITS {                                 // bit descriptions
...
struct GPFMUX2_BITS {                                 // bit descriptions
    Uint16  GPIO176:2;                                // 1:0 Defines pin-muxing selection for GPIO176 
    Uint16  GPIO177:2;                                // 3:2 Defines pin-muxing selection for GPIO177 
    Uint16  GPIO178:2;                                // 5:4 Defines pin-muxing selection for GPIO178 
    Uint16  GPIO179:2;                                // 7:6 Defines pin-muxing selection for GPIO179 
    Uint16  GPIO180:2;                                // 9:8 Defines pin-muxing selection for GPIO180 
    Uint16  GPIO181:2;                                // 11:10 Defines pin-muxing selection for GPIO181 
    Uint16  GPIO182:2;                                // 13:12 Defines pin-muxing selection for GPIO182 
    Uint16  GPIO183:2;                                // 15:14 Defines pin-muxing selection for GPIO183 
    Uint16  GPIO184:2;                                // 17:16 Defines pin-muxing selection for GPIO184 
    Uint16  GPIO185:2;                                // 19:18 Defines pin-muxing selection for GPIO185 
    Uint16  GPIO186:2;                                // 21:20 Defines pin-muxing selection for GPIO186 
    Uint16  GPIO187:2;                                // 23:22 Defines pin-muxing selection for GPIO187 
    Uint16  GPIO188:2;                                // 25:24 Defines pin-muxing selection for GPIO188 
    Uint16  GPIO189:2;                                // 27:26 Defines pin-muxing selection for GPIO189 
    Uint16  GPIO190:2;                                // 29:28 Defines pin-muxing selection for GPIO190 
    Uint16  GPIO191:2;                                // 31:30 Defines pin-muxing selection for GPIO191 
};
...
struct GPAGMUX1_BITS {                                // bit descriptions
    Uint16  GPIO0:2;                                  // 1:0 Defines pin-muxing selection for GPIO0 
    Uint16  GPIO1:2;                                  // 3:2 Defines pin-muxing selection for GPIO1 
    Uint16  GPIO2:2;                                  // 5:4 Defines pin-muxing selection for GPIO2 
    Uint16  GPIO3:2;                                  // 7:6 Defines pin-muxing selection for GPIO3 
...
struct GPBGMUX1_BITS {                                // bit descriptions
    Uint16  GPIO32:2;                                 // 1:0 Defines pin-muxing selection for GPIO32 
    Uint16  GPIO33:2;                                 // 3:2 Defines pin-muxing selection for GPIO33 
    Uint16  GPIO34:2;                                 // 5:4 Defines pin-muxing selection for GPIO34 
    Uint16  GPIO35:2;                                 // 7:6 Defines pin-muxing selection for GPIO35 
...
struct GPCGMUX1_BITS {                                // bit descriptions
    Uint16  GPIO64:2;                                 // 1:0 Defines pin-muxing selection for GPIO64 
    Uint16  GPIO65:2;                                 // 3:2 Defines pin-muxing selection for GPIO65 
    Uint16  GPIO66:2;                                 // 5:4 Defines pin-muxing selection for GPIO66 
    Uint16  GPIO67:2;                                 // 7:6 Defines pin-muxing selection for GPIO67 
...
struct GPDGMUX1_BITS {                                // bit descriptions
    Uint16  GPIO96:2;                                 // 1:0 Defines pin-muxing selection for GPIO96 
    Uint16  GPIO97:2;                                 // 3:2 Defines pin-muxing selection for GPIO97 
    Uint16  GPIO98:2;                                 // 5:4 Defines pin-muxing selection for GPIO98 
    Uint16  GPIO99:2;                                 // 7:6 Defines pin-muxing selection for GPIO99 
...
struct GPEGMUX1_BITS {                                // bit descriptions
    Uint16  GPIO128:2;                                // 1:0 Defines pin-muxing selection for GPIO128 
    Uint16  GPIO129:2;                                // 3:2 Defines pin-muxing selection for GPIO129 
    Uint16  GPIO130:2;                                // 5:4 Defines pin-muxing selection for GPIO130 
    Uint16  GPIO131:2;                                // 7:6 Defines pin-muxing selection for GPIO131 
...
struct GPFGMUX1_BITS {                                // bit descriptions
    Uint16  GPIO160:2;                                // 1:0 Defines pin-muxing selection for GPIO160 
    Uint16  GPIO161:2;                                // 3:2 Defines pin-muxing selection for GPIO161 
    Uint16  GPIO162:2;                                // 5:4 Defines pin-muxing selection for GPIO162 
    Uint16  GPIO163:2;                                // 7:6 Defines pin-muxing selection for GPIO163 
...
struct GPAGMUX2_BITS {                                // bit descriptions
    Uint16  GPIO16:2;                                 // 1:0 Defines pin-muxing selection for GPIO16 
    Uint16  GPIO17:2;                                 // 3:2 Defines pin-muxing selection for GPIO17 
    Uint16  GPIO18:2;                                 // 5:4 Defines pin-muxing selection for GPIO18 
    Uint16  GPIO19:2;                                 // 7:6 Defines pin-muxing selection for GPIO19 
...
struct GPBGMUX2_BITS {                                // bit descriptions
    Uint16  GPIO48:2;                                 // 1:0 Defines pin-muxing selection for GPIO48 
    Uint16  GPIO49:2;                                 // 3:2 Defines pin-muxing selection for GPIO49 
    Uint16  GPIO50:2;                                 // 5:4 Defines pin-muxing selection for GPIO50 
    Uint16  GPIO51:2;                                 // 7:6 Defines pin-muxing selection for GPIO51 
...
struct GPCGMUX2_BITS {                                // bit descriptions
    Uint16  GPIO80:2;                                 // 1:0 Defines pin-muxing selection for GPIO80 
    Uint16  GPIO81:2;                                 // 3:2 Defines pin-muxing selection for GPIO81 
    Uint16  GPIO82:2;                                 // 5:4 Defines pin-muxing selection for GPIO82 
    Uint16  GPIO83:2;                                 // 7:6 Defines pin-muxing selection for GPIO83 
...
struct GPDGMUX2_BITS {                                // bit descriptions
    Uint16  GPIO112:2;                                // 1:0 Defines pin-muxing selection for GPIO112 
    Uint16  GPIO113:2;                                // 3:2 Defines pin-muxing selection for GPIO113 
    Uint16  GPIO114:2;                                // 5:4 Defines pin-muxing selection for GPIO114 
    Uint16  GPIO115:2;                                // 7:6 Defines pin-muxing selection for GPIO115 
...
struct GPEGMUX2_BITS {                                // bit descriptions
    Uint16  GPIO144:2;                                // 1:0 Defines pin-muxing selection for GPIO144 
    Uint16  GPIO145:2;                                // 3:2 Defines pin-muxing selection for GPIO145 
    Uint16  GPIO146:2;                                // 5:4 Defines pin-muxing selection for GPIO146 
    Uint16  GPIO147:2;                                // 7:6 Defines pin-muxing selection for GPIO147 
...
struct GPFGMUX2_BITS {                                // bit descriptions
    Uint16  GPIO176:2;                                // 1:0 Defines pin-muxing selection for GPIO176 
    Uint16  GPIO177:2;                                // 3:2 Defines pin-muxing selection for GPIO177 
    Uint16  GPIO178:2;                                // 5:4 Defines pin-muxing selection for GPIO178 
    Uint16  GPIO179:2;                                // 7:6 Defines pin-muxing selection for GPIO179 
...
struct GPADIR_BITS {                                  // bit descriptions
...
struct GPBDIR_BITS {                                  // bit descriptions
...
struct GPCDIR_BITS {                                  // bit descriptions
...
struct GPDDIR_BITS {                                  // bit descriptions
...
struct GPEDIR_BITS {                                  // bit descriptions
...
struct GPFDIR_BITS {                                  // bit descriptions
    ...
    Uint16  GPIO169:1;                                // 9 Defines direction for this pin in GPIO mode 
    Uint16  GPIO170:1;                                // 10 Defines direction for this pin in GPIO mode 
    Uint16  GPIO171:1;                                // 11 Defines direction for this pin in GPIO mode 
    Uint16  GPIO172:1;                                // 12 Defines direction for this pin in GPIO mode 
    Uint16  GPIO173:1;                                // 13 Defines direction for this pin in GPIO mode 
    Uint16  GPIO174:1;                                // 14 Defines direction for this pin in GPIO mode 
    Uint16  GPIO175:1;                                // 15 Defines direction for this pin in GPIO mode 
    Uint16  GPIO176:1;                                // 16 Defines direction for this pin in GPIO mode 
    Uint16  GPIO177:1;                                // 17 Defines direction for this pin in GPIO mode 
    Uint16  GPIO178:1;                                // 18 Defines direction for this pin in GPIO mode 
    Uint16  GPIO179:1;                                // 19 Defines direction for this pin in GPIO mode 
    Uint16  GPIO180:1;                                // 20 Defines direction for this pin in GPIO mode 
    Uint16  GPIO181:1;                                // 21 Defines direction for this pin in GPIO mode 
    Uint16  GPIO182:1;                                // 22 Defines direction for this pin in GPIO mode 
    Uint16  GPIO183:1;                                // 23 Defines direction for this pin in GPIO mode 
    Uint16  GPIO184:1;                                // 24 Defines direction for this pin in GPIO mode 
    Uint16  GPIO185:1;                                // 25 Defines direction for this pin in GPIO mode 
    Uint16  GPIO186:1;                                // 26 Defines direction for this pin in GPIO mode 
    Uint16  GPIO187:1;                                // 27 Defines direction for this pin in GPIO mode 
    Uint16  GPIO188:1;                                // 28 Defines direction for this pin in GPIO mode 
    Uint16  GPIO189:1;                                // 29 Defines direction for this pin in GPIO mode 
    Uint16  GPIO190:1;                                // 30 Defines direction for this pin in GPIO mode 
    Uint16  GPIO191:1;                                // 31 Defines direction for this pin in GPIO mode 
};
...
struct GPAPUD_BITS {                                  // bit descriptions
...
struct GPBPUD_BITS {                                  // bit descriptions
...
struct GPCPUD_BITS {                                  // bit descriptions
...
struct GPDPUD_BITS {                                  // bit descriptions
...
struct GPEPUD_BITS {                                  // bit descriptions
...
struct GPFPUD_BITS {                                  // bit descriptions
    ...
    Uint16  GPIO169:1;                                // 9 Pull-Up Disable control for this pin 
    Uint16  GPIO170:1;                                // 10 Pull-Up Disable control for this pin 
    Uint16  GPIO171:1;                                // 11 Pull-Up Disable control for this pin 
    Uint16  GPIO172:1;                                // 12 Pull-Up Disable control for this pin 
    Uint16  GPIO173:1;                                // 13 Pull-Up Disable control for this pin 
    Uint16  GPIO174:1;                                // 14 Pull-Up Disable control for this pin 
    Uint16  GPIO175:1;                                // 15 Pull-Up Disable control for this pin 
    Uint16  GPIO176:1;                                // 16 Pull-Up Disable control for this pin 
    Uint16  GPIO177:1;                                // 17 Pull-Up Disable control for this pin 
    Uint16  GPIO178:1;                                // 18 Pull-Up Disable control for this pin 
    Uint16  GPIO179:1;                                // 19 Pull-Up Disable control for this pin 
    Uint16  GPIO180:1;                                // 20 Pull-Up Disable control for this pin 
    Uint16  GPIO181:1;                                // 21 Pull-Up Disable control for this pin 
    Uint16  GPIO182:1;                                // 22 Pull-Up Disable control for this pin 
    Uint16  GPIO183:1;                                // 23 Pull-Up Disable control for this pin 
    Uint16  GPIO184:1;                                // 24 Pull-Up Disable control for this pin 
    Uint16  GPIO185:1;                                // 25 Pull-Up Disable control for this pin 
    Uint16  GPIO186:1;                                // 26 Pull-Up Disable control for this pin 
    Uint16  GPIO187:1;                                // 27 Pull-Up Disable control for this pin 
    Uint16  GPIO188:1;                                // 28 Pull-Up Disable control for this pin 
    Uint16  GPIO189:1;                                // 29 Pull-Up Disable control for this pin 
    Uint16  GPIO190:1;                                // 30 Pull-Up Disable control for this pin 
    Uint16  GPIO191:1;                                // 31 Pull-Up Disable control for this pin 
};
...
struct GPAINV_BITS {                                  // bit descriptions
...
struct GPBINV_BITS {                                  // bit descriptions
...
struct GPCINV_BITS {                                  // bit descriptions
...
struct GPDINV_BITS {                                  // bit descriptions
...
struct GPEINV_BITS {                                  // bit descriptions
...
struct GPFINV_BITS {                                  // bit descriptions
    ...
    Uint16  GPIO169:1;                                // 9 Input inversion control for this pin 
    Uint16  GPIO170:1;                                // 10 Input inversion control for this pin 
    Uint16  GPIO171:1;                                // 11 Input inversion control for this pin 
    Uint16  GPIO172:1;                                // 12 Input inversion control for this pin 
    Uint16  GPIO173:1;                                // 13 Input inversion control for this pin 
    Uint16  GPIO174:1;                                // 14 Input inversion control for this pin 
    Uint16  GPIO175:1;                                // 15 Input inversion control for this pin 
    Uint16  GPIO176:1;                                // 16 Input inversion control for this pin 
    Uint16  GPIO177:1;                                // 17 Input inversion control for this pin 
    Uint16  GPIO178:1;                                // 18 Input inversion control for this pin 
    Uint16  GPIO179:1;                                // 19 Input inversion control for this pin 
    Uint16  GPIO180:1;                                // 20 Input inversion control for this pin 
    Uint16  GPIO181:1;                                // 21 Input inversion control for this pin 
    Uint16  GPIO182:1;                                // 22 Input inversion control for this pin 
    Uint16  GPIO183:1;                                // 23 Input inversion control for this pin 
    Uint16  GPIO184:1;                                // 24 Input inversion control for this pin 
    Uint16  GPIO185:1;                                // 25 Input inversion control for this pin 
    Uint16  GPIO186:1;                                // 26 Input inversion control for this pin 
    Uint16  GPIO187:1;                                // 27 Input inversion control for this pin 
    Uint16  GPIO188:1;                                // 28 Input inversion control for this pin 
    Uint16  GPIO189:1;                                // 29 Input inversion control for this pin 
    Uint16  GPIO190:1;                                // 30 Input inversion control for this pin 
    Uint16  GPIO191:1;                                // 31 Input inversion control for this pin 
};
...
struct GPAODR_BITS {                                  // bit descriptions
...
struct GPBODR_BITS {                                  // bit descriptions
...
struct GPCODR_BITS {                                  // bit descriptions
...
struct GPDODR_BITS {                                  // bit descriptions
...
struct GPEODR_BITS {                                  // bit descriptions
...
struct GPFODR_BITS {                                  // bit descriptions
    ...
    Uint16  GPIO169:1;                                // 9 Outpout Open-Drain control for this pin 
    Uint16  GPIO170:1;                                // 10 Outpout Open-Drain control for this pin 
    Uint16  GPIO171:1;                                // 11 Outpout Open-Drain control for this pin 
    Uint16  GPIO172:1;                                // 12 Outpout Open-Drain control for this pin 
    Uint16  GPIO173:1;                                // 13 Outpout Open-Drain control for this pin 
    Uint16  GPIO174:1;                                // 14 Outpout Open-Drain control for this pin 
    Uint16  GPIO175:1;                                // 15 Outpout Open-Drain control for this pin 
    Uint16  GPIO176:1;                                // 16 Outpout Open-Drain control for this pin 
    Uint16  GPIO177:1;                                // 17 Outpout Open-Drain control for this pin 
    Uint16  GPIO178:1;                                // 18 Outpout Open-Drain control for this pin 
    Uint16  GPIO179:1;                                // 19 Outpout Open-Drain control for this pin 
    Uint16  GPIO180:1;                                // 20 Outpout Open-Drain control for this pin 
    Uint16  GPIO181:1;                                // 21 Outpout Open-Drain control for this pin 
    Uint16  GPIO182:1;                                // 22 Outpout Open-Drain control for this pin 
    Uint16  GPIO183:1;                                // 23 Outpout Open-Drain control for this pin 
    Uint16  GPIO184:1;                                // 24 Outpout Open-Drain control for this pin 
    Uint16  GPIO185:1;                                // 25 Outpout Open-Drain control for this pin 
    Uint16  GPIO186:1;                                // 26 Outpout Open-Drain control for this pin 
    Uint16  GPIO187:1;                                // 27 Outpout Open-Drain control for this pin 
    Uint16  GPIO188:1;                                // 28 Outpout Open-Drain control for this pin 
    Uint16  GPIO189:1;                                // 29 Outpout Open-Drain control for this pin 
    Uint16  GPIO190:1;                                // 30 Outpout Open-Drain control for this pin 
    Uint16  GPIO191:1;                                // 31 Outpout Open-Drain control for this pin 
};
...
struct GPAAMSEL_BITS {                                // bit descriptions
    Uint16  GPIO0:1;                                  // 0 Analog Mode select for this pin 
    Uint16  GPIO1:1;                                  // 1 Analog Mode select for this pin 
    Uint16  GPIO2:1;                                  // 2 Analog Mode select for this pin 
    Uint16  GPIO3:1;                                  // 3 Analog Mode select for this pin 
    Uint16  GPIO4:1;                                  // 4 Analog Mode select for this pin 
    Uint16  GPIO5:1;                                  // 5 Analog Mode select for this pin 
    Uint16  GPIO6:1;                                  // 6 Analog Mode select for this pin 
    Uint16  GPIO7:1;                                  // 7 Analog Mode select for this pin 
    Uint16  GPIO8:1;                                  // 8 Analog Mode select for this pin 
    Uint16  GPIO9:1;                                  // 9 Analog Mode select for this pin 
    Uint16  GPIO10:1;                                 // 10 Analog Mode select for this pin 
    ...
    Uint16  GPIO14:1;                                 // 14 Analog Mode select for this pin 
    Uint16  GPIO15:1;                                 // 15 Analog Mode select for this pin 
    Uint16  GPIO16:1;                                 // 16 Analog Mode select for this pin 
    Uint16  GPIO17:1;                                 // 17 Analog Mode select for this pin 
    Uint16  GPIO18:1;                                 // 18 Analog Mode select for this pin 
    Uint16  GPIO19:1;                                 // 19 Analog Mode select for this pin 
    ...
    Uint16  GPIO25:1;                                 // 25 Analog Mode select for this pin 
    Uint16  GPIO26:1;                                 // 26 Analog Mode select for this pin 
    Uint16  GPIO27:1;                                 // 27 Analog Mode select for this pin 
    Uint16  GPIO28:1;                                 // 28 Analog Mode select for this pin 
    Uint16  GPIO29:1;                                 // 29 Analog Mode select for this pin 
    Uint16  GPIO30:1;                                 // 30 Analog Mode select for this pin 
    Uint16  GPIO31:1;                                 // 31 Analog Mode select for this pin 
};
...
struct GPBAMSEL_BITS {                                // bit descriptions
    Uint16  GPIO32:1;                                 // 0 Analog Mode select for this pin 
    Uint16  GPIO33:1;                                 // 1 Analog Mode select for this pin 
    Uint16  GPIO34:1;                                 // 2 Analog Mode select for this pin 
    Uint16  GPIO35:1;                                 // 3 Analog Mode select for this pin 
    Uint16  GPIO36:1;                                 // 4 Analog Mode select for this pin 
    Uint16  GPIO37:1;                                 // 5 Analog Mode select for this pin 
    Uint16  GPIO38:1;                                 // 6 Analog Mode select for this pin 
    Uint16  GPIO39:1;                                 // 7 Analog Mode select for this pin 
    Uint16  GPIO40:1;                                 // 8 Analog Mode select for this pin 
    ...
    Uint16  GPIO44:1;                                 // 12 Analog Mode select for this pin 
    Uint16  GPIO45:1;                                 // 13 Analog Mode select for this pin 
    Uint16  GPIO46:1;                                 // 14 Analog Mode select for this pin 
    Uint16  GPIO47:1;                                 // 15 Analog Mode select for this pin 
    Uint16  GPIO48:1;                                 // 16 Analog Mode select for this pin 
    Uint16  GPIO49:1;                                 // 17 Analog Mode select for this pin 
    Uint16  GPIO50:1;                                 // 18 Analog Mode select for this pin 
    Uint16  GPIO51:1;                                 // 19 Analog Mode select for this pin 
    Uint16  GPIO52:1;                                 // 20 Analog Mode select for this pin 
    Uint16  GPIO53:1;                                 // 21 Analog Mode select for this pin 
    Uint16  GPIO54:1;                                 // 22 Analog Mode select for this pin 
    Uint16  GPIO55:1;                                 // 23 Analog Mode select for this pin 
    Uint16  GPIO56:1;                                 // 24 Analog Mode select for this pin 
    Uint16  GPIO57:1;                                 // 25 Analog Mode select for this pin 
    Uint16  GPIO58:1;                                 // 26 Analog Mode select for this pin 
    Uint16  GPIO59:1;                                 // 27 Analog Mode select for this pin 
    Uint16  GPIO60:1;                                 // 28 Analog Mode select for this pin 
    Uint16  GPIO61:1;                                 // 29 Analog Mode select for this pin 
    Uint16  GPIO62:1;                                 // 30 Analog Mode select for this pin 
    Uint16  GPIO63:1;                                 // 31 Analog Mode select for this pin 
};
...
struct GPCAMSEL_BITS {                                // bit descriptions
    Uint16  GPIO64:1;                                 // 0 Analog Mode select for this pin 
    Uint16  GPIO65:1;                                 // 1 Analog Mode select for this pin 
    Uint16  GPIO66:1;                                 // 2 Analog Mode select for this pin 
    Uint16  GPIO67:1;                                 // 3 Analog Mode select for this pin 
    Uint16  GPIO68:1;                                 // 4 Analog Mode select for this pin 
    Uint16  GPIO69:1;                                 // 5 Analog Mode select for this pin 
    Uint16  GPIO70:1;                                 // 6 Analog Mode select for this pin 
    Uint16  GPIO71:1;                                 // 7 Analog Mode select for this pin 
    Uint16  GPIO72:1;                                 // 8 Analog Mode select for this pin 
    Uint16  GPIO73:1;                                 // 9 Analog Mode select for this pin 
    Uint16  GPIO74:1;                                 // 10 Analog Mode select for this pin 
    Uint16  GPIO75:1;                                 // 11 Analog Mode select for this pin 
    Uint16  GPIO76:1;                                 // 12 Analog Mode select for this pin 
    Uint16  GPIO77:1;                                 // 13 Analog Mode select for this pin 
    Uint16  GPIO78:1;                                 // 14 Analog Mode select for this pin 
    Uint16  GPIO79:1;                                 // 15 Analog Mode select for this pin 
    Uint16  GPIO80:1;                                 // 16 Analog Mode select for this pin 
    Uint16  GPIO81:1;                                 // 17 Analog Mode select for this pin 
    Uint16  GPIO82:1;                                 // 18 Analog Mode select for this pin 
    Uint16  GPIO83:1;                                 // 19 Analog Mode select for this pin 
    Uint16  GPIO84:1;                                 // 20 Analog Mode select for this pin 
    Uint16  GPIO85:1;                                 // 21 Analog Mode select for this pin 
    Uint16  GPIO86:1;                                 // 22 Analog Mode select for this pin 
    Uint16  GPIO87:1;                                 // 23 Analog Mode select for this pin 
    Uint16  GPIO88:1;                                 // 24 Analog Mode select for this pin 
    Uint16  GPIO89:1;                                 // 25 Analog Mode select for this pin 
    Uint16  GPIO90:1;                                 // 26 Analog Mode select for this pin 
    Uint16  GPIO91:1;                                 // 27 Analog Mode select for this pin 
    Uint16  GPIO92:1;                                 // 28 Analog Mode select for this pin 
    Uint16  GPIO93:1;                                 // 29 Analog Mode select for this pin 
    Uint16  GPIO94:1;                                 // 30 Analog Mode select for this pin 
    Uint16  GPIO95:1;                                 // 31 Analog Mode select for this pin 
};

union GPCAMSEL_REG {
    Uint32  all;  
    struct  GPCAMSEL_BITS  bit;  
};

struct GPDAMSEL_BITS {                                // bit descriptions
    Uint16  GPIO96:1;                                 // 0 Analog Mode select for this pin 
    Uint16  GPIO97:1;                                 // 1 Analog Mode select for this pin 
    Uint16  GPIO98:1;                                 // 2 Analog Mode select for this pin 
    Uint16  GPIO99:1;                                 // 3 Analog Mode select for this pin 
    Uint16  GPIO100:1;                                // 4 Analog Mode select for this pin 
    Uint16  GPIO101:1;                                // 5 Analog Mode select for this pin 
    Uint16  GPIO102:1;                                // 6 Analog Mode select for this pin 
    Uint16  GPIO103:1;                                // 7 Analog Mode select for this pin 
    Uint16  GPIO104:1;                                // 8 Analog Mode select for this pin 
    Uint16  GPIO105:1;                                // 9 Analog Mode select for this pin 
    Uint16  GPIO106:1;                                // 10 Analog Mode select for this pin 
    Uint16  GPIO107:1;                                // 11 Analog Mode select for this pin 
    Uint16  GPIO108:1;                                // 12 Analog Mode select for this pin 
    Uint16  GPIO109:1;                                // 13 Analog Mode select for this pin 
    Uint16  GPIO110:1;                                // 14 Analog Mode select for this pin 
    Uint16  GPIO111:1;                                // 15 Analog Mode select for this pin 
    Uint16  GPIO112:1;                                // 16 Analog Mode select for this pin 
    Uint16  GPIO113:1;                                // 17 Analog Mode select for this pin 
    Uint16  GPIO114:1;                                // 18 Analog Mode select for this pin 
    Uint16  GPIO115:1;                                // 19 Analog Mode select for this pin 
    Uint16  GPIO116:1;                                // 20 Analog Mode select for this pin 
    Uint16  GPIO117:1;                                // 21 Analog Mode select for this pin 
    Uint16  GPIO118:1;                                // 22 Analog Mode select for this pin 
    Uint16  GPIO119:1;                                // 23 Analog Mode select for this pin 
    Uint16  GPIO120:1;                                // 24 Analog Mode select for this pin 
    Uint16  GPIO121:1;                                // 25 Analog Mode select for this pin 
    Uint16  GPIO122:1;                                // 26 Analog Mode select for this pin 
    Uint16  GPIO123:1;                                // 27 Analog Mode select for this pin 
    Uint16  GPIO124:1;                                // 28 Analog Mode select for this pin 
    Uint16  GPIO125:1;                                // 29 Analog Mode select for this pin 
    Uint16  GPIO126:1;                                // 30 Analog Mode select for this pin 
    Uint16  GPIO127:1;                                // 31 Analog Mode select for this pin 
};

union GPDAMSEL_REG {
    Uint32  all;  
    struct  GPDAMSEL_BITS  bit;  
};

struct GPEAMSEL_BITS {                                // bit descriptions
    Uint16  GPIO128:1;                                // 0 Analog Mode select for this pin 
    Uint16  GPIO129:1;                                // 1 Analog Mode select for this pin 
    Uint16  GPIO130:1;                                // 2 Analog Mode select for this pin 
    Uint16  GPIO131:1;                                // 3 Analog Mode select for this pin 
    Uint16  GPIO132:1;                                // 4 Analog Mode select for this pin 
    Uint16  GPIO133:1;                                // 5 Analog Mode select for this pin 
    Uint16  GPIO134:1;                                // 6 Analog Mode select for this pin 
    Uint16  GPIO135:1;                                // 7 Analog Mode select for this pin 
    Uint16  GPIO136:1;                                // 8 Analog Mode select for this pin 
    Uint16  GPIO137:1;                                // 9 Analog Mode select for this pin 
    Uint16  GPIO138:1;                                // 10 Analog Mode select for this pin 
    Uint16  GPIO139:1;                                // 11 Analog Mode select for this pin 
    Uint16  GPIO140:1;                                // 12 Analog Mode select for this pin 
    Uint16  GPIO141:1;                                // 13 Analog Mode select for this pin 
    Uint16  GPIO142:1;                                // 14 Analog Mode select for this pin 
    Uint16  GPIO143:1;                                // 15 Analog Mode select for this pin 
    Uint16  GPIO144:1;                                // 16 Analog Mode select for this pin 
    Uint16  GPIO145:1;                                // 17 Analog Mode select for this pin 
    Uint16  GPIO146:1;                                // 18 Analog Mode select for this pin 
    Uint16  GPIO147:1;                                // 19 Analog Mode select for this pin 
    Uint16  GPIO148:1;                                // 20 Analog Mode select for this pin 
    Uint16  GPIO149:1;                                // 21 Analog Mode select for this pin 
    Uint16  GPIO150:1;                                // 22 Analog Mode select for this pin 
    Uint16  GPIO151:1;                                // 23 Analog Mode select for this pin 
    Uint16  GPIO152:1;                                // 24 Analog Mode select for this pin 
    Uint16  GPIO153:1;                                // 25 Analog Mode select for this pin 
    Uint16  GPIO154:1;                                // 26 Analog Mode select for this pin 
    Uint16  GPIO155:1;                                // 27 Analog Mode select for this pin 
    Uint16  GPIO156:1;                                // 28 Analog Mode select for this pin 
    Uint16  GPIO157:1;                                // 29 Analog Mode select for this pin 
    Uint16  GPIO158:1;                                // 30 Analog Mode select for this pin 
    Uint16  GPIO159:1;                                // 31 Analog Mode select for this pin 
};

union GPEAMSEL_REG {
    Uint32  all;  
    struct  GPEAMSEL_BITS  bit;  
};

struct GPFAMSEL_BITS {                                // bit descriptions
    Uint16  GPIO160:1;                                // 0 Analog Mode select for this pin 
    Uint16  GPIO161:1;                                // 1 Analog Mode select for this pin 
    Uint16  GPIO162:1;                                // 2 Analog Mode select for this pin 
    Uint16  GPIO163:1;                                // 3 Analog Mode select for this pin 
    Uint16  GPIO164:1;                                // 4 Analog Mode select for this pin 
    Uint16  GPIO165:1;                                // 5 Analog Mode select for this pin 
    Uint16  GPIO166:1;                                // 6 Analog Mode select for this pin 
    Uint16  GPIO167:1;                                // 7 Analog Mode select for this pin 
    Uint16  GPIO168:1;                                // 8 Analog Mode select for this pin 
    Uint16  GPIO169:1;                                // 9 Analog Mode select for this pin 
    Uint16  GPIO170:1;                                // 10 Analog Mode select for this pin 
    Uint16  GPIO171:1;                                // 11 Analog Mode select for this pin 
    Uint16  GPIO172:1;                                // 12 Analog Mode select for this pin 
    Uint16  GPIO173:1;                                // 13 Analog Mode select for this pin 
    Uint16  GPIO174:1;                                // 14 Analog Mode select for this pin 
    Uint16  GPIO175:1;                                // 15 Analog Mode select for this pin 
    Uint16  GPIO176:1;                                // 16 Analog Mode select for this pin 
    Uint16  GPIO177:1;                                // 17 Analog Mode select for this pin 
    Uint16  GPIO178:1;                                // 18 Analog Mode select for this pin 
    Uint16  GPIO179:1;                                // 19 Analog Mode select for this pin 
    Uint16  GPIO180:1;                                // 20 Analog Mode select for this pin 
    Uint16  GPIO181:1;                                // 21 Analog Mode select for this pin 
    Uint16  GPIO182:1;                                // 22 Analog Mode select for this pin 
    Uint16  GPIO183:1;                                // 23 Analog Mode select for this pin 
    Uint16  GPIO184:1;                                // 24 Analog Mode select for this pin 
    Uint16  GPIO185:1;                                // 25 Analog Mode select for this pin 
    Uint16  GPIO186:1;                                // 26 Analog Mode select for this pin 
    Uint16  GPIO187:1;                                // 27 Analog Mode select for this pin 
    Uint16  GPIO188:1;                                // 28 Analog Mode select for this pin 
    Uint16  GPIO189:1;                                // 29 Analog Mode select for this pin 
    Uint16  GPIO190:1;                                // 30 Analog Mode select for this pin 
    Uint16  GPIO191:1;                                // 31 Analog Mode select for this pin 
};

union GPFAMSEL_REG {
    Uint32  all;  
    struct  GPFAMSEL_BITS  bit;  
};

struct GPALOCK_BITS {                                 // bit descriptions
...
struct GPBLOCK_BITS {                                 // bit descriptions
...
struct GPCLOCK_BITS {                                 // bit descriptions
...
struct GPDLOCK_BITS {                                 // bit descriptions
...
struct GPELOCK_BITS {                                 // bit descriptions
...
struct GPFLOCK_BITS {                                 // bit descriptions
    ...
    Uint16  GPIO169:1;                                // 9 Configuration Lock bit for this pin 
    Uint16  GPIO170:1;                                // 10 Configuration Lock bit for this pin 
    Uint16  GPIO171:1;                                // 11 Configuration Lock bit for this pin 
    Uint16  GPIO172:1;                                // 12 Configuration Lock bit for this pin 
    Uint16  GPIO173:1;                                // 13 Configuration Lock bit for this pin 
    Uint16  GPIO174:1;                                // 14 Configuration Lock bit for this pin 
    Uint16  GPIO175:1;                                // 15 Configuration Lock bit for this pin 
    Uint16  GPIO176:1;                                // 16 Configuration Lock bit for this pin 
    Uint16  GPIO177:1;                                // 17 Configuration Lock bit for this pin 
    Uint16  GPIO178:1;                                // 18 Configuration Lock bit for this pin 
    Uint16  GPIO179:1;                                // 19 Configuration Lock bit for this pin 
    Uint16  GPIO180:1;                                // 20 Configuration Lock bit for this pin 
    Uint16  GPIO181:1;                                // 21 Configuration Lock bit for this pin 
    Uint16  GPIO182:1;                                // 22 Configuration Lock bit for this pin 
    Uint16  GPIO183:1;                                // 23 Configuration Lock bit for this pin 
    Uint16  GPIO184:1;                                // 24 Configuration Lock bit for this pin 
    Uint16  GPIO185:1;                                // 25 Configuration Lock bit for this pin 
    Uint16  GPIO186:1;                                // 26 Configuration Lock bit for this pin 
    Uint16  GPIO187:1;                                // 27 Configuration Lock bit for this pin 
    Uint16  GPIO188:1;                                // 28 Configuration Lock bit for this pin 
    Uint16  GPIO189:1;                                // 29 Configuration Lock bit for this pin 
    Uint16  GPIO190:1;                                // 30 Configuration Lock bit for this pin 
    Uint16  GPIO191:1;                                // 31 Configuration Lock bit for this pin 
};
...
struct GPACR_BITS {                                   // bit descriptions
...
struct GPBCR_BITS {                                   // bit descriptions
...
struct GPCCR_BITS {                                   // bit descriptions
...
struct GPDCR_BITS {                                   // bit descriptions
...
struct GPECR_BITS {                                   // bit descriptions
...
struct GPFCR_BITS {                                   // bit descriptions
    ...
    Uint16  GPIO169:1;                                // 9 Configuration lock commit bit for this pin 
    Uint16  GPIO170:1;                                // 10 Configuration lock commit bit for this pin 
    Uint16  GPIO171:1;                                // 11 Configuration lock commit bit for this pin 
    Uint16  GPIO172:1;                                // 12 Configuration lock commit bit for this pin 
    Uint16  GPIO173:1;                                // 13 Configuration lock commit bit for this pin 
    Uint16  GPIO174:1;                                // 14 Configuration lock commit bit for this pin 
    Uint16  GPIO175:1;                                // 15 Configuration lock commit bit for this pin 
    Uint16  GPIO176:1;                                // 16 Configuration lock commit bit for this pin 
    Uint16  GPIO177:1;                                // 17 Configuration lock commit bit for this pin 
    Uint16  GPIO178:1;                                // 18 Configuration lock commit bit for this pin 
    Uint16  GPIO179:1;                                // 19 Configuration lock commit bit for this pin 
    Uint16  GPIO180:1;                                // 20 Configuration lock commit bit for this pin 
    Uint16  GPIO181:1;                                // 21 Configuration lock commit bit for this pin 
    Uint16  GPIO182:1;                                // 22 Configuration lock commit bit for this pin 
    Uint16  GPIO183:1;                                // 23 Configuration lock commit bit for this pin 
    Uint16  GPIO184:1;                                // 24 Configuration lock commit bit for this pin 
    Uint16  GPIO185:1;                                // 25 Configuration lock commit bit for this pin 
    Uint16  GPIO186:1;                                // 26 Configuration lock commit bit for this pin 
    Uint16  GPIO187:1;                                // 27 Configuration lock commit bit for this pin 
    Uint16  GPIO188:1;                                // 28 Configuration lock commit bit for this pin 
    Uint16  GPIO189:1;                                // 29 Configuration lock commit bit for this pin 
    Uint16  GPIO190:1;                                // 30 Configuration lock commit bit for this pin 
    Uint16  GPIO191:1;                                // 31 Configuration lock commit bit for this pin 
};
...
struct GPADAT_BITS {                                  // bit descriptions
...
struct GPBDAT_BITS {                                  // bit descriptions
...
struct GPCDAT_BITS {                                  // bit descriptions
...
struct GPDDAT_BITS {                                  // bit descriptions
...
struct GPEDAT_BITS {                                  // bit descriptions
...
struct GPFDAT_BITS {                                  // bit descriptions
    ...
    Uint16  GPIO169:1;                                // 9 Data Register for this pin 
    Uint16  GPIO170:1;                                // 10 Data Register for this pin 
    Uint16  GPIO171:1;                                // 11 Data Register for this pin 
    Uint16  GPIO172:1;                                // 12 Data Register for this pin 
    Uint16  GPIO173:1;                                // 13 Data Register for this pin 
    Uint16  GPIO174:1;                                // 14 Data Register for this pin 
    Uint16  GPIO175:1;                                // 15 Data Register for this pin 
    Uint16  GPIO176:1;                                // 16 Data Register for this pin 
    Uint16  GPIO177:1;                                // 17 Data Register for this pin 
    Uint16  GPIO178:1;                                // 18 Data Register for this pin 
    Uint16  GPIO179:1;                                // 19 Data Register for this pin 
    Uint16  GPIO180:1;                                // 20 Data Register for this pin 
    Uint16  GPIO181:1;                                // 21 Data Register for this pin 
    Uint16  GPIO182:1;                                // 22 Data Register for this pin 
    Uint16  GPIO183:1;                                // 23 Data Register for this pin 
    Uint16  GPIO184:1;                                // 24 Data Register for this pin 
    Uint16  GPIO185:1;                                // 25 Data Register for this pin 
    Uint16  GPIO186:1;                                // 26 Data Register for this pin 
    Uint16  GPIO187:1;                                // 27 Data Register for this pin 
    Uint16  GPIO188:1;                                // 28 Data Register for this pin 
    Uint16  GPIO189:1;                                // 29 Data Register for this pin 
    Uint16  GPIO190:1;                                // 30 Data Register for this pin 
    Uint16  GPIO191:1;                                // 31 Data Register for this pin 
};
...
struct GPASET_BITS {                                  // bit descriptions
...
struct GPBSET_BITS {                                  // bit descriptions
...
struct GPCSET_BITS {                                  // bit descriptions
...
struct GPDSET_BITS {                                  // bit descriptions
...
struct GPESET_BITS {                                  // bit descriptions
...
struct GPFSET_BITS {                                  // bit descriptions
    ...
    Uint16  GPIO169:1;                                // 9 Output Set bit for this pin 
    Uint16  GPIO170:1;                                // 10 Output Set bit for this pin 
    Uint16  GPIO171:1;                                // 11 Output Set bit for this pin 
    Uint16  GPIO172:1;                                // 12 Output Set bit for this pin 
    Uint16  GPIO173:1;                                // 13 Output Set bit for this pin 
    Uint16  GPIO174:1;                                // 14 Output Set bit for this pin 
    Uint16  GPIO175:1;                                // 15 Output Set bit for this pin 
    Uint16  GPIO176:1;                                // 16 Output Set bit for this pin 
    Uint16  GPIO177:1;                                // 17 Output Set bit for this pin 
    Uint16  GPIO178:1;                                // 18 Output Set bit for this pin 
    Uint16  GPIO179:1;                                // 19 Output Set bit for this pin 
    Uint16  GPIO180:1;                                // 20 Output Set bit for this pin 
    Uint16  GPIO181:1;                                // 21 Output Set bit for this pin 
    Uint16  GPIO182:1;                                // 22 Output Set bit for this pin 
    Uint16  GPIO183:1;                                // 23 Output Set bit for this pin 
    Uint16  GPIO184:1;                                // 24 Output Set bit for this pin 
    Uint16  GPIO185:1;                                // 25 Output Set bit for this pin 
    Uint16  GPIO186:1;                                // 26 Output Set bit for this pin 
    Uint16  GPIO187:1;                                // 27 Output Set bit for this pin 
    Uint16  GPIO188:1;                                // 28 Output Set bit for this pin 
    Uint16  GPIO189:1;                                // 29 Output Set bit for this pin 
    Uint16  GPIO190:1;                                // 30 Output Set bit for this pin 
    Uint16  GPIO191:1;                                // 31 Output Set bit for this pin 
};
...
struct GPACLEAR_BITS {                                // bit descriptions
...
struct GPBCLEAR_BITS {                                // bit descriptions
...
struct GPCCLEAR_BITS {                                // bit descriptions
...
struct GPDCLEAR_BITS {                                // bit descriptions
...
struct GPECLEAR_BITS {                                // bit descriptions
...
struct GPFCLEAR_BITS {                                // bit descriptions
    ...
    Uint16  GPIO169:1;                                // 9 Output Clear bit for this pin 
    Uint16  GPIO170:1;                                // 10 Output Clear bit for this pin 
    Uint16  GPIO171:1;                                // 11 Output Clear bit for this pin 
    Uint16  GPIO172:1;                                // 12 Output Clear bit for this pin 
    Uint16  GPIO173:1;                                // 13 Output Clear bit for this pin 
    Uint16  GPIO174:1;                                // 14 Output Clear bit for this pin 
    Uint16  GPIO175:1;                                // 15 Output Clear bit for this pin 
    Uint16  GPIO176:1;                                // 16 Output Clear bit for this pin 
    Uint16  GPIO177:1;                                // 17 Output Clear bit for this pin 
    Uint16  GPIO178:1;                                // 18 Output Clear bit for this pin 
    Uint16  GPIO179:1;                                // 19 Output Clear bit for this pin 
    Uint16  GPIO180:1;                                // 20 Output Clear bit for this pin 
    Uint16  GPIO181:1;                                // 21 Output Clear bit for this pin 
    Uint16  GPIO182:1;                                // 22 Output Clear bit for this pin 
    Uint16  GPIO183:1;                                // 23 Output Clear bit for this pin 
    Uint16  GPIO184:1;                                // 24 Output Clear bit for this pin 
    Uint16  GPIO185:1;                                // 25 Output Clear bit for this pin 
    Uint16  GPIO186:1;                                // 26 Output Clear bit for this pin 
    Uint16  GPIO187:1;                                // 27 Output Clear bit for this pin 
    Uint16  GPIO188:1;                                // 28 Output Clear bit for this pin 
    Uint16  GPIO189:1;                                // 29 Output Clear bit for this pin 
    Uint16  GPIO190:1;                                // 30 Output Clear bit for this pin 
    Uint16  GPIO191:1;                                // 31 Output Clear bit for this pin 
};
...
struct GPATOGGLE_BITS {                               // bit descriptions
...
struct GPBTOGGLE_BITS {                               // bit descriptions
...
struct GPCTOGGLE_BITS {                               // bit descriptions
...
struct GPDTOGGLE_BITS {                               // bit descriptions
...
struct GPETOGGLE_BITS {                               // bit descriptions
...
struct GPFTOGGLE_BITS {                               // bit descriptions
    ...
    Uint16  GPIO169:1;                                // 9 Output Toggle bit for this pin 
    Uint16  GPIO170:1;                                // 10 Output Toggle bit for this pin 
    Uint16  GPIO171:1;                                // 11 Output Toggle bit for this pin 
    Uint16  GPIO172:1;                                // 12 Output Toggle bit for this pin 
    Uint16  GPIO173:1;                                // 13 Output Toggle bit for this pin 
    Uint16  GPIO174:1;                                // 14 Output Toggle bit for this pin 
    Uint16  GPIO175:1;                                // 15 Output Toggle bit for this pin 
    Uint16  GPIO176:1;                                // 16 Output Toggle bit for this pin 
    Uint16  GPIO177:1;                                // 17 Output Toggle bit for this pin 
    Uint16  GPIO178:1;                                // 18 Output Toggle bit for this pin 
    Uint16  GPIO179:1;                                // 19 Output Toggle bit for this pin 
    Uint16  GPIO180:1;                                // 20 Output Toggle bit for this pin 
    Uint16  GPIO181:1;                                // 21 Output Toggle bit for this pin 
    Uint16  GPIO182:1;                                // 22 Output Toggle bit for this pin 
    Uint16  GPIO183:1;                                // 23 Output Toggle bit for this pin 
    Uint16  GPIO184:1;                                // 24 Output Toggle bit for this pin 
    Uint16  GPIO185:1;                                // 25 Output Toggle bit for this pin 
    Uint16  GPIO186:1;                                // 26 Output Toggle bit for this pin 
    Uint16  GPIO187:1;                                // 27 Output Toggle bit for this pin 
    Uint16  GPIO188:1;                                // 28 Output Toggle bit for this pin 
    Uint16  GPIO189:1;                                // 29 Output Toggle bit for this pin 
    Uint16  GPIO190:1;                                // 30 Output Toggle bit for this pin 
    Uint16  GPIO191:1;                                // 31 Output Toggle bit for this pin 
};
...
struct GPACSEL1_BITS {                                // bit descriptions
...
struct GPACSEL2_BITS {                                // bit descriptions
...
struct GPACSEL3_BITS {                                // bit descriptions
...
struct GPACSEL4_BITS {                                // bit descriptions
...
struct GPBCSEL1_BITS {                                // bit descriptions
...
struct GPBCSEL2_BITS {                                // bit descriptions
...
struct GPBCSEL3_BITS {                                // bit descriptions
...
struct GPBCSEL4_BITS {                                // bit descriptions
...
struct GPCCSEL1_BITS {                                // bit descriptions
...
struct GPCCSEL2_BITS {                                // bit descriptions
...
struct GPCCSEL3_BITS {                                // bit descriptions
...
struct GPCCSEL4_BITS {                                // bit descriptions
...
struct GPDCSEL1_BITS {                                // bit descriptions
...
struct GPDCSEL2_BITS {                                // bit descriptions
...
struct GPDCSEL3_BITS {                                // bit descriptions
...
struct GPDCSEL4_BITS {                                // bit descriptions
...
struct GPECSEL1_BITS {                                // bit descriptions
...
struct GPECSEL2_BITS {                                // bit descriptions
...
struct GPECSEL3_BITS {                                // bit descriptions
...
struct GPECSEL4_BITS {                                // bit descriptions
...
struct GPFCSEL1_BITS {                                // bit descriptions
...
struct GPFCSEL2_BITS {                                // bit descriptions
    Uint16  GPIO168:4;                                // 3:0 GPIO168 Master CPU Select 
    Uint16  GPIO169:4;                                // 7:4 GPIO169 Master CPU Select 
    Uint16  GPIO170:4;                                // 11:8 GPIO170 Master CPU Select 
    Uint16  GPIO171:4;                                // 15:12 GPIO171 Master CPU Select 
    Uint16  GPIO172:4;                                // 19:16 GPIO172 Master CPU Select 
    Uint16  GPIO173:4;                                // 23:20 GPIO173 Master CPU Select 
    Uint16  GPIO174:4;                                // 27:24 GPIO174 Master CPU Select 
    Uint16  GPIO175:4;                                // 31:28 GPIO175 Master CPU Select 
};
...
struct GPFCSEL3_BITS {                                // bit descriptions
    Uint16  GPIO176:4;                                // 3:0 GPIO176 Master CPU Select 
    Uint16  GPIO177:4;                                // 7:4 GPIO177 Master CPU Select 
    Uint16  GPIO178:4;                                // 11:8 GPIO178 Master CPU Select 
    Uint16  GPIO179:4;                                // 15:12 GPIO179 Master CPU Select 
    Uint16  GPIO180:4;                                // 19:16 GPIO180 Master CPU Select 
    Uint16  GPIO181:4;                                // 23:20 GPIO181 Master CPU Select 
    Uint16  GPIO182:4;                                // 27:24 GPIO182 Master CPU Select 
    Uint16  GPIO183:4;                                // 31:28 GPIO183 Master CPU Select 
};
...
struct GPFCSEL4_BITS {                                // bit descriptions
    Uint16  GPIO184:4;                                // 3:0 GPIO184 Master CPU Select 
    Uint16  GPIO185:4;                                // 7:4 GPIO185 Master CPU Select 
    Uint16  GPIO186:4;                                // 11:8 GPIO186 Master CPU Select 
    Uint16  GPIO187:4;                                // 15:12 GPIO187 Master CPU Select 
    Uint16  GPIO188:4;                                // 19:16 GPIO188 Master CPU Select 
    Uint16  GPIO189:4;                                // 23:20 GPIO189 Master CPU Select 
    Uint16  GPIO190:4;                                // 27:24 GPIO190 Master CPU Select 
    Uint16  GPIO191:4;                                // 31:28 GPIO191 Master CPU Select 
};
...
struct GPIO_CTRL_REGS {
    ...
    union   GPCCTRL_REG      GPCCTRL;                 // GPIO C Control Register (GPIO64 to 95) 
    ...
    union   GPCAMSEL_REG     GPCAMSEL;                // GPIO C Analog Mode Select register (GPIO64 to GPIO95) 
    ...
    union   GPDCTRL_REG      GPDCTRL;                 // GPIO D Control Register (GPIO96 to 127) 
    ...
    union   GPDAMSEL_REG     GPDAMSEL;                // GPIO D Analog Mode Select register (GPIO96 to GPIO127) 
    ...
    union   GPECTRL_REG      GPECTRL;                 // GPIO E Control Register (GPIO128 to 159) 
    ...
    union   GPEAMSEL_REG     GPEAMSEL;                // GPIO E Analog Mode Select register (GPIO128 to GPIO159) 
    ...
    union   GPFCTRL_REG      GPFCTRL;                 // GPIO F Control Register (GPIO160 to 191) 
    union   GPFQSEL1_REG     GPFQSEL1;                // GPIO F Qualifier Select 1 Register (GPIO160 to 175) 
    union   GPFQSEL2_REG     GPFQSEL2;                // GPIO F Qualifier Select 2 Register (GPIO176 to 191) 
    union   GPFMUX1_REG      GPFMUX1;                 // GPIO F Mux 1 Register (GPIO160 to 175) 
    union   GPFMUX2_REG      GPFMUX2;                 // GPIO F Mux 2 Register (GPIO176 to 191) 
    union   GPFDIR_REG       GPFDIR;                  // GPIO F Direction Register (GPIO160 to 191) 
    union   GPFPUD_REG       GPFPUD;                  // GPIO F Pull Up Disable Register (GPIO160 to 191) 
    Uint16                   rsvd21[2];               // Reserved 
    union   GPFINV_REG       GPFINV;                  // GPIO F Input Polarity Invert Registers (GPIO160 to 191) 
    union   GPFODR_REG       GPFODR;                  // GPIO F Open Drain Output Register (GPIO160 to GPIO191) 
    union   GPFAMSEL_REG     GPFAMSEL;                // GPIO F Analog Mode Select register (GPIO160 to GPIO191) 
    Uint16                   rsvd22[10];              // Reserved 
    union   GPFGMUX1_REG     GPFGMUX1;                // GPIO F Peripheral Group Mux (GPIO160 to 175) 
    union   GPFGMUX2_REG     GPFGMUX2;                // GPIO F Peripheral Group Mux (GPIO176 to 191) 
    Uint16                   rsvd23[4];               // Reserved 
    union   GPFCSEL1_REG     GPFCSEL1;                // GPIO F Core Select Register (GPIO160 to 167) 
    union   GPFCSEL2_REG     GPFCSEL2;                // GPIO F Core Select Register (GPIO168 to 175) 
    union   GPFCSEL3_REG     GPFCSEL3;                // GPIO F Core Select Register (GPIO176 to 183) 
    union   GPFCSEL4_REG     GPFCSEL4;                // GPIO F Core Select Register (GPIO184 to 191) 
    Uint16                   rsvd24[12];              // Reserved 
    union   GPFLOCK_REG      GPFLOCK;                 // GPIO F Lock Configuration Register (GPIO160 to 191) 
    union   GPFCR_REG        GPFCR;                   // GPIO F Lock Commit Register (GPIO160 to 191) 
};
#endif
...
struct GPIO_DATA_REGS {
    ...
    union   GPFDAT_REG       GPFDAT;                  // GPIO F Data Register (GPIO160 to 191) 
    union   GPFSET_REG       GPFSET;                  // GPIO F Data Set Register (GPIO160 to 191) 
    union   GPFCLEAR_REG     GPFCLEAR;                // GPIO F Data Clear Register (GPIO160 to 191) 
    union   GPFTOGGLE_REG    GPFTOGGLE;               // GPIO F Data Toggle Register (GPIO160 to 191) 
};
...
#endif                                                // end of F2837x_GPIO_H definition
//===========================================================================
// End of file.
//===========================================================================
