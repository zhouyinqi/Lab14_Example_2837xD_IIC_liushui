...
struct Z1_OTPSECLOCK_BITS {                              // bit descriptions
    Uint16  rsvd1:4;                                  // 3:0 Zone1 JTAG Lock. 
...
struct Z2_OTPSECLOCK_BITS {                              // bit descriptions
    Uint16  rsvd1:4;                                  // 3:0 Zone2 JTAG Lock. 
...
extern volatile struct DCSM_OTP_Z1 DcsmZ1Otp;
extern volatile struct DCSM_OTP_Z2 DcsmZ2Otp;
extern volatile struct DCSM_REGS_Z1 DcsmZ1Regs;
extern volatile struct DCSM_REGS_Z2 DcsmZ2Regs;
extern volatile struct DCSM_REGS_COMMON DcsmCommonRegs;
