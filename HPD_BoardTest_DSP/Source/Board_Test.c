...
static const BoardTest_Descriptor BoardTest_Descriptors[BOARD_TEST_ITEM_COUNT] =
{
    ...
    {BOARD_TEST_ID_SYS_INTERRUPT, "SYS_INTERRUPT", BOARD_TEST_CAP_IMPLEMENTED, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_BOARD_MASK, 0U},
    ...
    {BOARD_TEST_ID_PWM_BASIC, "PWM_BASIC", BOARD_TEST_CAP_IMPLEMENTED, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_BOARD_MASK, 1U},
    ...
    {BOARD_TEST_ID_SPI_EXTERNAL, "SPIC_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 1U},
    {BOARD_TEST_ID_SPIB_FLASH_EXTERNAL, "SPIB_FLASH_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 1U},
    {BOARD_TEST_ID_SPIB_FRAM_EXTERNAL, "SPIB_FRAM_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 1U},
    ...
    {BOARD_TEST_ID_EMIF_EXTERNAL, "EMIF_SRAM_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 1U},
    {BOARD_TEST_ID_ETHERNET, "ETHERNET", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 1U},
    ...
    {BOARD_TEST_ID_CAN_EXTERNAL, "CAN_USB_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_I2C_EXTERNAL, "I2C_EXTERNAL", BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_SCI_RS485_EXTERNAL, "SCI_RS485_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_RS422_EXTERNAL, "RS422_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_SCIA_HANDHELD_EXTERNAL, "SCIA_HANDHELD_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_HPD_ESTOP_DI3, "HPD_ESTOP_DI3", BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_HPD_INDICATOR_DO3, "HPD_INDICATOR_DO3", BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    ...
    {BOARD_TEST_ID_EMIF_BASIC, "EMIF_BASIC", BOARD_TEST_CAP_IMPLEMENTED, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_BOARD_MASK, 1U},
    {BOARD_TEST_ID_ETHERNET_SOCKET, "ETHERNET_SOCKET", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 1U},
    {BOARD_TEST_ID_ETHERNET_TCP_LINK, "ETHERNET_TCP_LINK", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_ETHERNET_TCP_ECHO, "ETHERNET_TCP_ECHO", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_ETHERNET_TCP_STABILITY, "ETHERNET_TCP_STABILITY", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_FPGA_EMIF2_BASIC, "FPGA_EMIF2_BASIC", BOARD_TEST_CAP_IMPLEMENTED, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_BOARD_MASK, 0U},
    {BOARD_TEST_ID_DIDO_FPGA_DO_EXTERNAL, "DO_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 1U},
    {BOARD_TEST_ID_HDO_FPGA_EXTERNAL, "HDO_FPGA_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_DI_FPGA_EXTERNAL, "DI_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 1U},
    {BOARD_TEST_ID_ADC_EXTERNAL_INJECTION, "ADC_EXTERNAL_INJECTION", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_EXTERNAL_INJECT | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_ADC_EXTERNAL_GROUP_1, "ADC_EXTERNAL_GROUP_1_X3", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_EXTERNAL_INJECT | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_ADC_EXTERNAL_GROUP_2, "ADC_EXTERNAL_GROUP_2_X4", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_EXTERNAL_INJECT | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_ADC_PT100_MUX_EXTERNAL, "ADC_PT100_MUX_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_EXTERNAL_INJECT | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_ADC_NTC_MUX_EXTERNAL, "ADC_NTC_MUX_RESERVED", BOARD_TEST_CAP_EXTERNAL_INJECT | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_ADC_FAULT_MUX_EXTERNAL, "ADC_FAULT_MUX_RETIRED", 0U, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_PWM_DIDO_EXTERNAL, "PWM_DIDO_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_DRIVER_FAULT_DI_EXTERNAL, "DRIVER_FAULT_DI_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_PROTECTION_FAULT_DI_EXTERNAL, "PROTECTION_THRESHOLD_XINT_CLEAR", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_EXTERNAL_INJECT | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_DRIVER_RESET_DO_EXTERNAL, "DRIVER_RESET_DO_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_LV_DI_EXTERNAL, "LV_DI6_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_LV_DO_EXTERNAL, "LV_DO3_AUX_EXTERNAL", 0U, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_LV_HDO_EXTERNAL, "LV_HDO_EXTERNAL", 0U, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_LV_STO_EXTERNAL, "LV_STO2_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_LV_ADC_EXTERNAL, "LV_ADC13_EXTERNAL", 0U, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_LV_PT100_EXTERNAL, "LV_PT100_EXTERNAL", 0U, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_LV_NTC_EXTERNAL, "LV_NTC_EXTERNAL", 0U, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_LV_PWM_EXTERNAL, "LV_PWM6_EXTERNAL", 0U, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_LV_PROTECTION_EXTERNAL, "LV_PROTECTION_XINT_CLEAR", 0U, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_LV_AO_EXTERNAL, "LV_AO_EXTERNAL", 0U, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U},
    {BOARD_TEST_ID_LV_RESOLVER_EXTERNAL, "LV_RESOLVER_EXTERNAL", 0U, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 0U}
};
                                               ...
                                               BoardTest_U16 stage)
{
    ...
    if(((stage == BOARD_TEST_STAGE_EXTERNAL_CONNECTED) ||
        (stage == BOARD_TEST_STAGE_HPD_INJECTION)) &&
...
static void BoardTest_SetProfileNotSupported(BoardTest_U16 index)
{
    BoardTest_Record *record = &gBoardTestManager.records[index];

    record->result = BOARD_TEST_RESULT_NOT_SUPPORTED;
...
static void BoardTest_SetProfileSafetyLocked(BoardTest_U16 index)
{
    BoardTest_Record *record = &gBoardTestManager.records[index];

    record->result = BOARD_TEST_RESULT_SAFETY_LOCKED;
    record->errorCode = BOARD_TEST_ERROR_PROFILE_NOT_CONFIRMED;
    record->rawValue = 0UL;
    record->measuredValue = 0.0F;
    record->expectedMin = 0.0F;
    record->expectedMax = 0.0F;
                                          ...
                                          BoardTest_Executor executor)
{
    ...
    {
        BoardTest_SetProfileSafetyLocked(index);
        result = BOARD_TEST_RESULT_SAFETY_LOCKED;
    }
    else if(BoardProfile_IsTestSupported(record->id) == 0U)
    {
        BoardTest_SetProfileNotSupported(index);
                                              ...
                                              BoardTest_U16 stage)
{
    ...
    if(BoardProfile_IsTestSupported(testId) == 0U)
    {
        BoardTest_SetProfileNotSupported(index);
        return BOARD_TEST_RESULT_NOT_SUPPORTED;
    }
    ...
    if((BoardTest_Descriptors[index].capabilities &
        BOARD_TEST_CAP_IMPLEMENTED) == 0U)
    {
        gBoardTestManager.records[index].result =
            BOARD_TEST_RESULT_NOT_SUPPORTED;
        gBoardTestManager.records[index].errorCode =
            BOARD_TEST_ERROR_UNSUPPORTED;
        gBoardTestManager.records[index].rawValue = 0UL;
        gBoardTestManager.records[index].measuredValue = 0.0F;
        gBoardTestManager.records[index].expectedMin = 0.0F;
        gBoardTestManager.records[index].expectedMax = 0.0F;
...
void BoardTest_Process(BoardTest_Executor executor)
{
    ...
    if(BoardProfile_IsTestSupported(BoardTest_Descriptors[index].id) == 0U)
    {
        BoardTest_SetProfileNotSupported(index);
        gBoardTestManager.autoIndex++;
        return;
...
const BoardTest_Descriptor *BoardTest_GetDescriptorById(BoardTest_U16 testId)
{
