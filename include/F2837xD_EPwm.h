...
// FILE:   F2837x_EPwm.h
//
// TITLE:  F2837x Device EPwm Register Definitions.
//
...
#ifndef F2837x_EPwm_H
#define F2837x_EPwm_H
#ifdef __cplusplus
extern "C" {
#endif
...
struct TBCTL_BITS {                                   // bit descriptions
...
struct TBCTL2_BITS {                                  // bit descriptions
...
struct TBSTS_BITS {                                   // bit descriptions
...
struct CMPCTL_BITS {                                  // bit descriptions
...
struct CMPCTL2_BITS {                                 // bit descriptions
...
struct DBCTL_BITS {                                   // bit descriptions
...
struct DBCTL2_BITS {                                  // bit descriptions
...
struct AQCTL_BITS {                                   // bit descriptions
...
struct AQTSRCSEL_BITS {                               // bit descriptions
...
struct PCCTL_BITS {                                   // bit descriptions
...
struct HRCNFG_BITS {                                  // bit descriptions
...
struct HRPWR_BITS {                                   // bit descriptions
...
struct HRMSTEP_BITS {                                 // bit descriptions
...
struct HRPCTL_BITS {                                  // bit descriptions
...
struct GLDCTL_BITS {                                  // bit descriptions
    Uint16  GLD:1;                                    // 0 Global Shadow to Active load event control 
    Uint16  GLDMODE:4;                                // 4:1 Global Load Pulse selection for Shadow to Active mode reloads 
    Uint16  OSHTMODE:1;                               // 5 One Shot Load mode control bit 
    Uint16  rsvd1:1;                                  // 6:6 Reserved 
...
struct GLDCFG_BITS {                                  // bit descriptions
...
struct EPWMXLINK_BITS {                               // bit descriptions
...
struct AQCTLA_BITS {                                  // bit descriptions
...
struct AQCTLB_BITS {                                  // bit descriptions
    Uint16  ZRO:2;                                    // 1:0 Action Counter = Zero 
    Uint16  PRD:2;                                    // 3:2 Action Counter = Period 
    Uint16  CAU:2;                                    // 5:4 Action Counter = Compare A Up 
    Uint16  CAD:2;                                    // 7:6 Action Counter = Compare A Down 
...
struct AQCTLA2_BITS {                                 // bit descriptions
...
struct AQCTLB2_BITS {                                 // bit descriptions
    Uint16  T1U:2;                                    // 1:0 Action when event occurs on T1 in UP-Count 
    Uint16  T1D:2;                                    // 3:2 Action when event occurs on T1 in DOWN-Count 
    Uint16  T2U:2;                                    // 5:4 Action when event occurs on T2 in UP-Count 
    Uint16  T2D:2;                                    // 7:6 Action when event occurs on T2 in DOWN-Count 
...
struct AQSFRC_BITS {                                  // bit descriptions
...
struct AQCSFRC_BITS {                                 // bit descriptions
...
struct DBREDHR_BITS {                                 // bit descriptions
    Uint16  rsvd1:9;                                  // 8:0 Reserved 
...
struct DBFEDHR_BITS {                                 // bit descriptions
    Uint16  rsvd1:9;                                  // 8:0 Reserved 
...
struct TBPHS_REG {                                    // bit descriptions
...
union TBPHS_GROUP {
    Uint32  all;  
    struct  TBPHS_REG  half;  
};

struct CMPA_REG {                                     // bit descriptions
...
union CMPA_GROUP {
    Uint32  all;  
    struct  CMPA_REG  half;  
};

struct CMPB_REG {                                     // bit descriptions
...
union CMPB_GROUP {
    Uint32  all;  
    struct  CMPB_REG  half;  
};

struct GLDCTL2_BITS {                                 // bit descriptions
...
struct TZSEL_BITS {                                   // bit descriptions
...
struct TZDCSEL_BITS {                                 // bit descriptions
...
struct TZCTL_BITS {                                   // bit descriptions
...
struct TZCTL2_BITS {                                  // bit descriptions
    Uint16  TZAU:3;                                   // 2:0 TZ1 to TZ6, DCAEVT1/2, DCBEVT1/2 Trip Action On EPWMxA while Count direction is UP 
    Uint16  TZAD:3;                                   // 5:3 TZ1 to TZ6, DCAEVT1/2, DCBEVT1/2 Trip Action On EPWMxA while Count direction is DOWN 
    Uint16  TZBU:3;                                   // 8:6 TZ1 to TZ6, DCAEVT1/2, DCBEVT1/2 Trip Action On EPWMxB while Count direction is UP 
    Uint16  TZBD:3;                                   // 11:9 TZ1 to TZ6, DCAEVT1/2, DCBEVT1/2 Trip Action On EPWMxB while Count direction is DOWN 
    Uint16  rsvd1:3;                                  // 14:12 Reserved 
    Uint16  ETZE:1;                                   // 15 If enabled Trip action defied in TZCTL2, TZCTLDCA and TZCTLDCB will take effect 
};
...
struct TZCTLDCA_BITS {                                // bit descriptions
    Uint16  DCAEVT1U:3;                               // 2:0 Digital Compare Output A Event 1 Action On EPWMxA while Count direction is UP 
    Uint16  DCAEVT1D:3;                               // 5:3 Digital Compare Output A Event 1 Action On EPWMxA while Count direction is DOWN 
    Uint16  DCAEVT2U:3;                               // 8:6 Digital Compare Output A Event 2 Action On EPWMxA while Count direction is UP 
    Uint16  DCAEVT2D:3;                               // 11:9 Digital Compare Output A Event 2 Action On EPWMxA while Count direction is DOWN 
    Uint16  rsvd1:4;                                  // 15:12 Reserved 
};
...
struct TZCTLDCB_BITS {                                // bit descriptions
    Uint16  DCBEVT1U:3;                               // 2:0 Digital Compare Output B Event 1 Action On EPWMxA while Count direction is UP 
    Uint16  DCBEVT1D:3;                               // 5:3 Digital Compare Output B Event 1 Action On EPWMxA while Count direction is DOWN 
    Uint16  DCBEVT2U:3;                               // 8:6 Digital Compare Output B Event 2 Action On EPWMxA while Count direction is UP 
    Uint16  DCBEVT2D:3;                               // 11:9 Digital Compare Output B Event 2 Action On EPWMxA while Count direction is DOWN 
    Uint16  rsvd1:4;                                  // 15:12 Reserved 
};
...
struct TZEINT_BITS {                                  // bit descriptions
...
struct TZFLG_BITS {                                   // bit descriptions
...
struct TZCBCFLG_BITS {                                // bit descriptions
...
struct TZOSTFLG_BITS {                                // bit descriptions
...
struct TZCLR_BITS {                                   // bit descriptions
...
struct TZCBCCLR_BITS {                                // bit descriptions
    ...
    Uint16  DCAEVT2:1;                                // 6 Clear Flag for Digital Compare Output A Event 2 selected for CBC 
    Uint16  DCBEVT2:1;                                // 7 Clear Flag for Digital Compare Output B Event 2 selected for CBC 
    Uint16  rsvd1:8;                                  // 15:8 Reserved 
};
...
struct TZOSTCLR_BITS {                                // bit descriptions
    ...
    Uint16  DCAEVT2:1;                                // 6 Clear Flag for Digital Compare Output A Event 1 selected for OST 
    Uint16  DCBEVT2:1;                                // 7 Clear Flag for Digital Compare Output B Event 1 selected for OST 
    Uint16  rsvd1:8;                                  // 15:8 Reserved 
};
...
struct TZFRC_BITS {                                   // bit descriptions
    Uint16  rsvd1:1;                                  // 0:0 Reserved 
...
struct ETSEL_BITS {                                   // bit descriptions
...
struct ETPS_BITS {                                    // bit descriptions
...
struct ETFLG_BITS {                                   // bit descriptions
...
struct ETCLR_BITS {                                   // bit descriptions
...
struct ETFRC_BITS {                                   // bit descriptions
...
struct ETINTPS_BITS {                                 // bit descriptions
...
struct ETSOCPS_BITS {                                 // bit descriptions
...
struct ETCNTINITCTL_BITS {                            // bit descriptions
...
struct ETCNTINIT_BITS {                               // bit descriptions
...
struct DCTRIPSEL_BITS {                               // bit descriptions
...
struct DCACTL_BITS {                                  // bit descriptions
...
struct DCBCTL_BITS {                                  // bit descriptions
...
struct DCFCTL_BITS {                                  // bit descriptions
...
struct DCCAPCTL_BITS {                                // bit descriptions
...
struct DCAHTRIPSEL_BITS {                             // bit descriptions
...
struct DCALTRIPSEL_BITS {                             // bit descriptions
...
struct DCBHTRIPSEL_BITS {                             // bit descriptions
...
struct DCBLTRIPSEL_BITS {                             // bit descriptions
...
struct EPWM_REGS {
    ...
    union   TBPHS_GROUP         TBPHS;                // Time Base Phase High 
    Uint16                      TBPRDHR;              // Time Base Period High Resolution Register 
    Uint16                      TBPRD;                // Time Base Period Register 
    Uint16                      rsvd16[6];            // Reserved 
    union   CMPA_GROUP          CMPA;                 // Counter Compare A Register 
    union   CMPB_GROUP          CMPB;                 // Compare B Register 
    Uint16                      rsvd17[1];            // Reserved 
    Uint16                      CMPC;                 // Counter Compare C Register 
    Uint16                      rsvd18[1];            // Reserved 
...
#endif                                                // end of F2837x_EPWM_H definition
//===========================================================================
// End of file.
//===========================================================================
