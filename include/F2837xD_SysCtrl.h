//###########################################################################
//
// FILE:   F2837x_SysCtrl.h
//
// TITLE:  F2837x Device SysCtrl Register Definitions.
//
...
#ifndef F2837x_SysCtrl_H
#define F2837x_SysCtrl_H
#ifdef __cplusplus
extern "C" {
#endif
...
struct DEVCFGLOCK1_BITS {                                    // bit descriptions
...
struct PARTIDH_BITS {                                        // bit descriptions
    Uint16  PARTIDH1:16;                                     // 15:0 Register 1 of the HIGH device PART Identification value 
    Uint16  PARTIDH2:8;                                      // 23:16 Register 2 of the HIGH device PART Identification value 
    Uint16  DEVICEID:8;                                      // 31:24 Device Identification Number 
};
...
struct DC0_BITS {                                            // bit descriptions
    Uint16  SINGLE_CORE:1;                                   // 0 Single Core vs Dual Core Configuration 
...
struct DC1_BITS {                                            // bit descriptions
...
struct DC2_BITS {                                            // bit descriptions
...
struct DC3_BITS {                                            // bit descriptions
...
struct DC4_BITS {                                            // bit descriptions
...
struct DC5_BITS {                                            // bit descriptions
...
struct DC6_BITS {                                            // bit descriptions
...
struct DC7_BITS {                                            // bit descriptions
    Uint16  SD1:1;                                           // 0 SD1 
    Uint16  SD2:1;                                           // 1 SD2 
    Uint16  rsvd1:14;                                        // 15:2 Reserved 
    Uint16  rsvd2:16;                                        // 31:16 Reserved 
...
struct DC8_BITS {                                            // bit descriptions
...
struct DC9_BITS {                                            // bit descriptions
...
struct DC10_BITS {                                           // bit descriptions
...
struct DC11_BITS {                                           // bit descriptions
...
struct DC12_BITS {                                           // bit descriptions
...
struct DC13_BITS {                                           // bit descriptions
...
struct DC14_BITS {                                           // bit descriptions
...
struct DC15_BITS {                                           // bit descriptions
...
struct DC17_BITS {                                           // bit descriptions
    Uint16  rsvd1:16;                                        // 15:0 Reserved 
...
struct DC18_BITS {                                           // bit descriptions
...
struct DC19_BITS {                                           // bit descriptions
...
struct DC20_BITS {                                           // bit descriptions
    Uint16  GS0:1;                                           // 0 GS0 
    Uint16  GS1:1;                                           // 1 GS1 
    Uint16  GS2:1;                                           // 2 GS2 
    Uint16  GS3:1;                                           // 3 GS3 
...
struct PERCNF1_BITS {                                        // bit descriptions
...
struct FUSEERR_BITS {                                        // bit descriptions
...
struct SOFTPRES0_BITS {                                      // bit descriptions
...
struct SOFTPRES1_BITS {                                      // bit descriptions
...
struct SOFTPRES2_BITS {                                      // bit descriptions
...
struct SOFTPRES3_BITS {                                      // bit descriptions
...
struct SOFTPRES4_BITS {                                      // bit descriptions
...
struct SOFTPRES5_BITS {                                      // bit descriptions
    Uint16  rsvd1:16;                                        // 15:0 Reserved 
    Uint16  rsvd2:16;                                        // 31:16 Reserved 
};
...
struct SOFTPRES6_BITS {                                      // bit descriptions
...
struct SOFTPRES7_BITS {                                      // bit descriptions
...
struct SOFTPRES8_BITS {                                      // bit descriptions
...
struct SOFTPRES9_BITS {                                      // bit descriptions
...
struct SOFTPRES11_BITS {                                     // bit descriptions
...
struct SOFTPRES13_BITS {                                     // bit descriptions
...
struct SOFTPRES14_BITS {                                     // bit descriptions
...
struct SOFTPRES16_BITS {                                     // bit descriptions
    Uint16  rsvd1:16;                                        // 15:0 Reserved 
...
struct CPUSEL0_BITS {                                        // bit descriptions
...
struct CPUSEL1_BITS {                                        // bit descriptions
...
struct CPUSEL2_BITS {                                        // bit descriptions
...
struct CPUSEL3_BITS {                                        // bit descriptions
    Uint16  rsvd1:16;                                        // 15:0 Reserved 
    Uint16  rsvd2:16;                                        // 31:16 Reserved 
};
...
struct CPUSEL4_BITS {                                        // bit descriptions
...
struct CPUSEL5_BITS {                                        // bit descriptions
...
struct CPUSEL6_BITS {                                        // bit descriptions
...
struct CPUSEL7_BITS {                                        // bit descriptions
...
struct CPUSEL8_BITS {                                        // bit descriptions
...
struct CPUSEL9_BITS {                                        // bit descriptions
...
struct CPUSEL11_BITS {                                       // bit descriptions
...
struct CPUSEL12_BITS {                                       // bit descriptions
...
struct CPUSEL14_BITS {                                       // bit descriptions
    Uint16  rsvd1:16;                                        // 15:0 Reserved 
...
struct CPU2RESCTL_BITS {                                     // bit descriptions
...
struct RSTSTAT_BITS {                                        // bit descriptions
    ...
    Uint16  CPU2HWBISTRST0:1;                                // 2 Tells whether a HWBIST reset was issued to CPU2 or not 
    Uint16  CPU2HWBISTRST1:1;                                // 3 Tells whether a HWBIST reset was issued to CPU2 or not 
    Uint16  rsvd1:12;                                        // 15:4 Reserved 
};
...
struct LPMSTAT_BITS {                                        // bit descriptions
...
struct PSCONCTL1_BITS {                                      // bit descriptions
    Uint16  FCPD_Sram_pcharge:8;                             // 7:0 This bit field is connected to FCPD.PSCON.Sram_pcharge input 
    Uint16  FCPD_Ponout_to_pgoodin_wait:8;                   // 15:8 This bit field is connected to FCPD.PSCON.Ponout_to_pgoodin_wait input 
    Uint16  rsvd1:16;                                        // 31:16 Reserved 
};

union PSCONCTL1_REG {
    Uint32  all;  
    struct  PSCONCTL1_BITS  bit;  
};

struct SYSDBGCTL_BITS {                                      // bit descriptions
    Uint16  HIBDIS:1;                                        // 0 HIB Disable configuration when debugger is connected 
    Uint16  rsvd1:15;                                        // 15:1 Reserved 
    Uint16  rsvd2:16;                                        // 31:16 Reserved 
};
...
struct CLKSEM_BITS {                                         // bit descriptions
...
struct CLKCFGLOCK1_BITS {                                    // bit descriptions
...
struct CLKSRCCTL1_BITS {                                     // bit descriptions
...
struct CLKSRCCTL2_BITS {                                     // bit descriptions
...
struct CLKSRCCTL3_BITS {                                     // bit descriptions
...
struct SYSPLLCTL1_BITS {                                     // bit descriptions
...
struct SYSPLLCTL2_BITS {                                     // bit descriptions
    Uint16  SSEN:1;                                          // 0 SYSPLL Spread Spectrum Modulation enable/disable Bit 
    Uint16  SPREADINGRATE:12;                                // 12:1 SYSPLL Spread Spectrum Modulation frequency Configuration 
    Uint16  rsvd1:3;                                         // 15:13 Reserved 
    Uint16  rsvd2:16;                                        // 31:16 Reserved 
};

union SYSPLLCTL2_REG {
    Uint32  all;  
    struct  SYSPLLCTL2_BITS  bit;  
};

struct SYSPLLCTL3_BITS {                                     // bit descriptions
    Uint16  SPR_FAMOUNT:15;                                  // 14:0 SYSPLL Modulation Depth 
    Uint32  SPR_IAMOUNT:11;                                  // 25:15 SYSPLL Modulation Depth 
    Uint16  rsvd1:6;                                         // 31:26 Reserved 
};

union SYSPLLCTL3_REG {
    Uint32  all;  
    struct  SYSPLLCTL3_BITS  bit;  
};

struct SYSPLLMULT_BITS {                                     // bit descriptions
...
struct SYSPLLSTS_BITS {                                      // bit descriptions
...
struct AUXPLLCTL1_BITS {                                     // bit descriptions
...
struct AUXPLLMULT_BITS {                                     // bit descriptions
...
struct AUXPLLSTS_BITS {                                      // bit descriptions
...
struct SYSCLKDIVSEL_BITS {                                   // bit descriptions
...
struct AUXCLKDIVSEL_BITS {                                   // bit descriptions
...
struct PERCLKDIVSEL_BITS {                                   // bit descriptions
...
struct XCLKOUTDIVSEL_BITS {                                  // bit descriptions
...
struct LOSPCP_BITS {                                         // bit descriptions
...
struct MCDCR_BITS {                                          // bit descriptions
...
struct X1CNT_BITS {                                          // bit descriptions
...
struct CPUSYSLOCK1_BITS {                                    // bit descriptions
...
struct IORESTOREADDR_BITS {                                  // bit descriptions
...
struct PIEVERRADDR_BITS {                                    // bit descriptions
...
struct PCLKCR0_BITS {                                        // bit descriptions
...
struct PCLKCR1_BITS {                                        // bit descriptions
...
struct PCLKCR2_BITS {                                        // bit descriptions
...
struct PCLKCR3_BITS {                                        // bit descriptions
...
struct PCLKCR4_BITS {                                        // bit descriptions
...
struct PCLKCR5_BITS {                                        // bit descriptions
    Uint16  rsvd1:16;                                        // 15:0 Reserved 
    Uint16  rsvd2:16;                                        // 31:16 Reserved 
};
...
struct PCLKCR6_BITS {                                        // bit descriptions
...
struct PCLKCR7_BITS {                                        // bit descriptions
...
struct PCLKCR8_BITS {                                        // bit descriptions
...
struct PCLKCR9_BITS {                                        // bit descriptions
...
struct PCLKCR10_BITS {                                       // bit descriptions
...
struct PCLKCR11_BITS {                                       // bit descriptions
...
struct PCLKCR12_BITS {                                       // bit descriptions
...
struct PCLKCR13_BITS {                                       // bit descriptions
...
struct PCLKCR14_BITS {                                       // bit descriptions
...
struct PCLKCR16_BITS {                                       // bit descriptions
    Uint16  rsvd1:16;                                        // 15:0 Reserved 
...
struct CCR_BITS {                                            // bit descriptions
    Uint16  VMAPS:1;                                         // 0 C28x cores VMAPS signal status 
    Uint16  MONPRIV:1;                                       // 1 C28x MONPRIV input signal enable bit 
    Uint16  ENPROT:1;                                        // 2 C28x ENPROT input signal value 
    Uint16  rsvd1:13;                                        // 15:3 Reserved 
    Uint16  rsvd2:16;                                        // 31:16 Reserved 
};
...
struct SECMSEL_BITS {                                        // bit descriptions
    Uint16  VBUS32_1:2;                                      // 1:0 Secondary Master Select for VBUS32_1 Bridge 
    Uint16  VBUS32_2:2;                                      // 3:2 Secondary Master Select for VBUS32_2 Bridge 
    Uint16  rsvd1:12;                                        // 15:4 Reserved 
    Uint16  rsvd2:16;                                        // 31:16 Reserved 
};
...
struct LPMCR_BITS {                                          // bit descriptions
...
struct GPIOLPMSEL0_BITS {                                    // bit descriptions
...
struct GPIOLPMSEL1_BITS {                                    // bit descriptions
...
struct TMR2CLKCTL_BITS {                                     // bit descriptions
...
struct RESC_BITS {                                           // bit descriptions
...
struct SCSR_BITS {                                           // bit descriptions
...
struct WDCNTR_BITS {                                         // bit descriptions
...
struct WDKEY_BITS {                                          // bit descriptions
...
struct WDCR_BITS {                                           // bit descriptions
...
struct WDWCR_BITS {                                          // bit descriptions
...
struct CLA1TASKSRCSELLOCK_BITS {                             // bit descriptions
...
struct DMACHSRCSELLOCK_BITS {                                // bit descriptions
...
struct CLA1TASKSRCSEL1_BITS {                                // bit descriptions
...
struct CLA1TASKSRCSEL2_BITS {                                // bit descriptions
...
struct DMACHSRCSEL1_BITS {                                   // bit descriptions
...
struct DMACHSRCSEL2_BITS {                                   // bit descriptions
...
struct DEV_CFG_REGS {
    ...
    Uint32                            PARTIDL;               // Lower 32-bit of Device PART Identification Number 
    ...
    Uint32                            DIEID0;                // DIE ID Register Bits 31:0 
    Uint32                            DIEID1;                // DIE ID Register Bits 63:32 
    Uint32                            DIEID2;                // DIE ID Register Bits 95:64 
    Uint32                            DIEID3;                // DIE ID Register Bits 127:96 
    ...
    union   PSCONCTL1_REG             PSCONCTL1;             // Register for PSCON Configuration 
...
struct CLK_CFG_REGS {
    ...
    union   SYSPLLCTL2_REG            SYSPLLCTL2;            // SYSPLL Control register-2 
    union   SYSPLLCTL3_REG            SYSPLLCTL3;            // SYSPLL Control register-3 
...
struct CPU_SYS_REGS {
    ...
    union   PCLKCR5_REG               PCLKCR5;               // Peripheral Clock Gating Registers 
    ...
    union   CCR_REG                   CCR;                   // Core Control register (t documented for users) 
...
#endif                                                       // end of F2837x_SYSCTRL_H definition
//===========================================================================
// End of file.
//===========================================================================
