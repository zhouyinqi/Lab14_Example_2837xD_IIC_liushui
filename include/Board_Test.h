...
#define BOARD_TEST_ERROR_RS422_EXTERNAL 0x0133U
...
#define BOARD_TEST_ERROR_SPI_EXTERNAL 0x0151U
#define BOARD_TEST_ERROR_SPIB_FLASH    0x0152U
#define BOARD_TEST_ERROR_SPIB_FRAM     0x0153U
...
typedef enum
{
    ...
    BOARD_TEST_ID_RS422_EXTERNAL = 0x0316U,
    BOARD_TEST_ID_SPIB_FLASH_EXTERNAL = 0x0317U,
    BOARD_TEST_ID_SPIB_FRAM_EXTERNAL = 0x0318U,
...
#define BOARD_TEST_ITEM_COUNT 50U
