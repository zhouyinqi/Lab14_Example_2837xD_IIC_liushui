...
// This function must reside in RAM
    ...
    if(*((Uint16 *)0x70280) == 0x5A5A){
        //device is trimmed, apply device calibration values
        //    (*Device_cal)();
    }else{
        //device is not trimmed, apply static calibration values
        AnalogSubsysRegs.ANAREFTRIMA = 31709;
        AnalogSubsysRegs.ANAREFTRIMB = 31709;
        AnalogSubsysRegs.ANAREFTRIMC = 31709;
        AnalogSubsysRegs.ANAREFTRIMD = 31709;
    }
    ...
    InitSysPll(XTAL_OSC,IMULT_20,FMULT_1,PLLCLK_BY_2); 		//PLLSYSCLK = 20Mhz(xtal) * 16 (IMULT) * 1 (FMULT) /  2 (PLLCLK_BY_2)  //IMULT_20

//    InitSysPll(XTAL_OSC,IMULT_16,FMULT_1,PLLCLK_BY_2); 		//PLLSYSCLK = 25Mhz(xtal) * 16 (IMULT) * 1 (FMULT) /  2 (PLLCLK_BY_2)  //IMULT_20
   //InitSysPll(INT_OSC2,IMULT_40,FMULT_1,PLLCLK_BY_2); 		//PLLSYSCLK = 10Mhz(OSCCLK) * 40 (IMULT) * 1 (FMULT) /  2 (PLLCLK_BY_2)  //IMULT_20
