...
#else
#pragma DATA_SECTION(DcsmZ1Regs,"DcsmRegsZ1File");
#endif
volatile struct DCSM_REGS_Z1 DcsmZ1Regs;

//----------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION("DcsmRegsZ2File")
#else
#pragma DATA_SECTION(DcsmZ2Regs,"DcsmRegsZ2File");
#endif
volatile struct DCSM_REGS_Z2 DcsmZ2Regs;

//----------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION("DcsmRegsCommonFile")
#else
#pragma DATA_SECTION(DcsmCommonRegs,"DcsmRegsCommonFile");
#endif
volatile struct DCSM_REGS_COMMON DcsmCommonRegs;

//----------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION("DcsmOtpZ1File")
#else
#pragma DATA_SECTION(DcsmZ1Otp,"DcsmOtpZ1File");
#endif
volatile struct DCSM_OTP_Z1 DcsmZ1Otp;

//----------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION("DcsmOtpZ2File")
#else
#pragma DATA_SECTION(DcsmZ2Otp,"DcsmOtpZ2File");
#endif
volatile struct DCSM_OTP_Z2 DcsmZ2Otp;
...
#else
#pragma DATA_SECTION(OutputXbarRegs,"GpioOutXbarRegsFile");
#endif
