...
static const BoardTest_Descriptor BoardTest_Descriptors[BOARD_TEST_ITEM_COUNT] =
{
    ...
    {BOARD_TEST_ID_DIDO_FPGA_DO_EXTERNAL, "DIDO_FPGA_DO_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_LOW_VOLTAGE, BOARD_TEST_STAGE_EXTERNAL_MASK, 1U},
    ...
    {BOARD_TEST_ID_DI_FPGA_EXTERNAL, "DI_FPGA_EXTERNAL", BOARD_TEST_CAP_IMPLEMENTED | BOARD_TEST_CAP_TEST_BENCH, BOARD_TEST_RISK_SAFE, BOARD_TEST_STAGE_EXTERNAL_MASK, 1U}
};
